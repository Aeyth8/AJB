...
public:
	...
	TDelegate<void(TArray<struct FBlueprintSessionResult>& Results)> K2Node_CreateDelegate_OutputDelegate4;             // 0x01C0(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(TArray<struct FBlueprintSessionResult>& Results)> K2Node_CreateDelegate_OutputDelegate5;             // 0x0218(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(BP_AJBGameInstance_C_IsFinishMatching, CallFunc_PlayModeEquals_bResult) == 0x000001, "Member 'BP_AJBGameInstance_C_IsFinishMatching::CallFunc_PlayModeEquals_bResult' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_IsFinishMatching, CallFunc_PlayModeEquals_bResult1) == 0x000002, "Member 'BP_AJBGameInstance_C_IsFinishMatching::CallFunc_PlayModeEquals_bResult1' has a wrong offset!");
...
static_assert(offsetof(BP_AJBGameInstance_C_IsFinishMatching, CallFunc_BooleanOR_ReturnValue) == 0x000010, "Member 'BP_AJBGameInstance_C_IsFinishMatching::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_GetCameramanNumber_Count;                 // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_AJBGameInstance_C_CheckSelecedAll) == 0x000038, "Wrong size on BP_AJBGameInstance_C_CheckSelecedAll");
...
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_GetCameramanNumber_Count) == 0x000014, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_GetCameramanNumber_Count' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_Map_Length_ReturnValue) == 0x000018, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_Map_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_Subtract_IntInt_ReturnValue) == 0x00001C, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_Add_IntInt_ReturnValue1) == 0x000020, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_Array_Get_Item) == 0x000024, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000028, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_Add_IntInt_ReturnValue2) == 0x00002C, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_Add_IntInt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_Array_Length_ReturnValue) == 0x000030, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_CheckSelecedAll, CallFunc_Less_IntInt_ReturnValue) == 0x000034, "Member 'BP_AJBGameInstance_C_CheckSelecedAll::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	class UAJBParamRepos*                         CallFunc_GetParamRepos_ReturnValue;                // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetFloatValue_ReturnValue;                // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetVectorValue_ReturnValue;               // 0x002C(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetFloatValue_ReturnValue1;               // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_GetDamegeAreaFileNameBase_File_Name_Base; // 0x0040(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UAJBParamFile*                          CallFunc_GetParamFile_ReturnValue;                 // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAJBParamContent*                       CallFunc_GetDefaultContent_ReturnValue;            // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_AJBGameInstance_C_InitializeDamageAreaParam) == 0x000078, "Wrong size on BP_AJBGameInstance_C_InitializeDamageAreaParam");
...
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_GetParamRepos_ReturnValue) == 0x000020, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_GetParamRepos_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_GetFloatValue_ReturnValue) == 0x000028, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_GetFloatValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_GetVectorValue_ReturnValue) == 0x00002C, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_GetVectorValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_GetFloatValue_ReturnValue1) == 0x000038, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_GetFloatValue_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_GetDamegeAreaFileNameBase_File_Name_Base) == 0x000040, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_GetDamegeAreaFileNameBase_File_Name_Base' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_Concat_StrStr_ReturnValue) == 0x000050, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_Conv_StringToName_ReturnValue) == 0x000060, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_GetParamFile_ReturnValue) == 0x000068, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_GetParamFile_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_InitializeDamageAreaParam, CallFunc_GetDefaultContent_ReturnValue) == 0x000070, "Member 'BP_AJBGameInstance_C_InitializeDamageAreaParam::CallFunc_GetDefaultContent_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_AJBGameInstance_C_GotoOutGameLevel, CallFunc_GetAJBHighlightManager_bIsValid) == 0x000000, "Member 'BP_AJBGameInstance_C_GotoOutGameLevel::CallFunc_GetAJBHighlightManager_bIsValid' has a wrong offset!");
...
static_assert(sizeof(BP_AJBGameInstance_C_PlayModeIsPair) == 0x000004, "Wrong size on BP_AJBGameInstance_C_PlayModeIsPair");
...
static_assert(offsetof(BP_AJBGameInstance_C_PlayModeIsPair, CallFunc_PlayModeEquals_bResult) == 0x000001, "Member 'BP_AJBGameInstance_C_PlayModeIsPair::CallFunc_PlayModeEquals_bResult' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_PlayModeIsPair, CallFunc_PlayModeEquals_bResult1) == 0x000002, "Member 'BP_AJBGameInstance_C_PlayModeIsPair::CallFunc_PlayModeEquals_bResult1' has a wrong offset!");
static_assert(offsetof(BP_AJBGameInstance_C_PlayModeIsPair, CallFunc_BooleanOR_ReturnValue) == 0x000003, "Member 'BP_AJBGameInstance_C_PlayModeIsPair::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
