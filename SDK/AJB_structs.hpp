...
static_assert(sizeof(FAJBGameRecord) == 0x000038, "Wrong size on FAJBGameRecord");
...
static_assert(sizeof(FAJBCharacterInfo) == 0x0000E0, "Wrong size on FAJBCharacterInfo");
...
static_assert(sizeof(FAJBStageAssetTableRow) == 0x000098, "Wrong size on FAJBStageAssetTableRow");
...
static_assert(sizeof(FControllerSettings) == 0x000008, "Wrong size on FControllerSettings");
...
public:
	...
	struct FControllerSettings                    ControllerSettings;                                // 0x0100(0x0008)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	class FString                                 SyncServerHostName;                                // 0x0108(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SyncServerPort;                                    // 0x0118(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11C[0x4];                                      // 0x011C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ResultAt;                                          // 0x0120(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDateTime                              LastMovieUploadedTime;                             // 0x0130(0x0008)(BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RequiredTicketNumForReward;                        // 0x0138(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_13C[0x4];                                      // 0x013C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDateTime                              LogoutTime;                                        // 0x0140(0x0008)(BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPlayerLoginInfo) == 0x000008, "Wrong alignment on FPlayerLoginInfo");
static_assert(sizeof(FPlayerLoginInfo) == 0x000148, "Wrong size on FPlayerLoginInfo");
...
static_assert(offsetof(FPlayerLoginInfo, SyncServerHostName) == 0x000108, "Member 'FPlayerLoginInfo::SyncServerHostName' has a wrong offset!");
static_assert(offsetof(FPlayerLoginInfo, SyncServerPort) == 0x000118, "Member 'FPlayerLoginInfo::SyncServerPort' has a wrong offset!");
static_assert(offsetof(FPlayerLoginInfo, ResultAt) == 0x000120, "Member 'FPlayerLoginInfo::ResultAt' has a wrong offset!");
static_assert(offsetof(FPlayerLoginInfo, LastMovieUploadedTime) == 0x000130, "Member 'FPlayerLoginInfo::LastMovieUploadedTime' has a wrong offset!");
static_assert(offsetof(FPlayerLoginInfo, RequiredTicketNumForReward) == 0x000138, "Member 'FPlayerLoginInfo::RequiredTicketNumForReward' has a wrong offset!");
static_assert(offsetof(FPlayerLoginInfo, LogoutTime) == 0x000140, "Member 'FPlayerLoginInfo::LogoutTime' has a wrong offset!");
