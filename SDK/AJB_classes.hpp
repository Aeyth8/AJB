...
class AAJBInGameAIController final : public AAIController
{
public:
...
class UAJBInGameAIDirectorComponent final : public UActorComponent
{
public:
...
class UAJBInGameAIEnvironmentComponent final : public UActorComponent
{
public:
...
class UAJBInGameAIInputProxyComponent final : public UActorComponent
{
public:
...
// 0x0000 (0x00F0 - 0x00F0)
class UAJBInGameAIRecognitionComponent final : public UActorComponent
{
public:
	static class UClass* StaticClass()
	{
...
public:
	...
	float                                         HearingAbilityRate;                                // 0x0778(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ViewPitchMin;                                      // 0x077C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ViewPitchMax;                                      // 0x0780(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InputPitchScale;                                   // 0x0784(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFinishedSkinChange;                               // 0x0788(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(AAJBInGameCharacterBase, HearingAbilityRate) == 0x000778, "Member 'AAJBInGameCharacterBase::HearingAbilityRate' has a wrong offset!");
static_assert(offsetof(AAJBInGameCharacterBase, ViewPitchMin) == 0x00077C, "Member 'AAJBInGameCharacterBase::ViewPitchMin' has a wrong offset!");
static_assert(offsetof(AAJBInGameCharacterBase, ViewPitchMax) == 0x000780, "Member 'AAJBInGameCharacterBase::ViewPitchMax' has a wrong offset!");
static_assert(offsetof(AAJBInGameCharacterBase, InputPitchScale) == 0x000784, "Member 'AAJBInGameCharacterBase::InputPitchScale' has a wrong offset!");
static_assert(offsetof(AAJBInGameCharacterBase, bFinishedSkinChange) == 0x000788, "Member 'AAJBInGameCharacterBase::bFinishedSkinChange' has a wrong offset!");
...
class AAJBInGameCameraman final : public AAJBInGameCharacterBase
{
public:
	static class UClass* StaticClass()
	{
...
class AAJBInGameCharacter final : public AAJBInGameCharacterBase
{
public:
...
class AAJBInGameEffectActor final : public AActor
{
public:
	bool IsBeingUsed();
...
class AAJBInGameEffectPoolManager final : public AActor
{
public:
...
// 0x0000 (0x0328 - 0x0328)
class AAJBInGameGate final : public AAJBInGameEnviroment
{
public:
	static class UClass* StaticClass()
	{
...
class AAJBInGameHUD final : public AAJBHUDBase
{
public:
...
class AAJBInGameMovableStand final : public AAJBInGameCharacterBase
{
public:
...
class AAJBBattleGameMode final : public AAJBInGameGameMode
{
public:
	static class UClass* StaticClass()
	{
...
class AAJBBattleGameState final : public AAJBInGameGameState
{
public:
...
class UAJBButtonWidget final : public UAJBUserWidget
{
public:
...
class UAJBCameraShake final : public UCameraShake
{
public:
...
// 0x0000 (0x0328 - 0x0328)
class AAJBCharaSelectMannequin final : public AActor
{
public:
...
public:
	...
	void AJBResponse__DelegateSignature(bool bIsSuccess, const struct FAJBGachaID& GachaID);
...
public:
	...
	class UAJBAMSystemSettings*                   AMSystemSettings;                                  // 0x00B0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAJBAMSystemObject*                     AMSystemObject;                                    // 0x00B8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAJBInGameServerInfo*                   InGameServerInfo;                                  // 0x00C0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPlayerLoginInfo                       PlayerLoginInfo;                                   // 0x00C8(0x0148)(BlueprintVisible, NativeAccessSpecifierPublic)
	TArray<struct FRoomPlayerInfo>                RoomPlayerData;                                    // 0x0210(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FRoomPlayerInfo                        PairRoomPlayerInfo;                                // 0x0220(0x0110)(BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<class FString, struct FMatchingPlayerInfo> MatchingPlayers;                                   // 0x0330(0x0050)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FMatchingPlayerInfo>            MachingNPC;                                        // 0x0380(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_390[0x20];                                     // 0x0390(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          IsInGameForNetworkError;                           // 0x03B0(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3B1[0x7];                                      // 0x03B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAJBNetworkObserver*                    NetworkObserverTask;                               // 0x03B8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ULoadingScreenManager>      LoadingScreenManagerClass;                         // 0x03C0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPlayMode                                     PlayMode;                                          // 0x03C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C9[0x3];                                      // 0x03C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAJBBattleSettings                     BattleSettings;                                    // 0x03CC(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_3D4[0x4];                                      // 0x03D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UAJBArcadeTimeManager>      ArcadeTimeManagerClass;                            // 0x03D8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAJBArcadeTimeManager*                  ArcadeTimeManager;                                 // 0x03E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDataTable*                             CharacterInfoTable;                                // 0x03E8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAJBServerAliveInfo                    ServerAliveInfo;                                   // 0x03F0(0x0014)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         MovieUploadRemainingNum;                           // 0x0404(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxMovieUploadNum;                                 // 0x0408(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsValidShopId;                                     // 0x040C(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_40D[0x3];                                      // 0x040D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	UMulticastDelegateProperty_                   OnStopReplayRecording;                             // 0x0410(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_420[0x8];                                      // 0x0420(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UAJBAMSystemObserver*                   AMSystemObserverTask;                              // 0x0428(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAJBHighlightManager*                   HighlightManager;                                  // 0x0430(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TMap<int32, struct FCustomData>               OfflineDefaultCustomData;                          // 0x0438(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<int32, int32>                            ExtraPPTable;                                      // 0x0488(0x0050)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAJBGameInstance) == 0x0004D8, "Wrong size on UAJBGameInstance");
...
static_assert(offsetof(UAJBGameInstance, AMSystemSettings) == 0x0000B0, "Member 'UAJBGameInstance::AMSystemSettings' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, AMSystemObject) == 0x0000B8, "Member 'UAJBGameInstance::AMSystemObject' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, InGameServerInfo) == 0x0000C0, "Member 'UAJBGameInstance::InGameServerInfo' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, PlayerLoginInfo) == 0x0000C8, "Member 'UAJBGameInstance::PlayerLoginInfo' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, RoomPlayerData) == 0x000210, "Member 'UAJBGameInstance::RoomPlayerData' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, PairRoomPlayerInfo) == 0x000220, "Member 'UAJBGameInstance::PairRoomPlayerInfo' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, MatchingPlayers) == 0x000330, "Member 'UAJBGameInstance::MatchingPlayers' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, MachingNPC) == 0x000380, "Member 'UAJBGameInstance::MachingNPC' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, IsInGameForNetworkError) == 0x0003B0, "Member 'UAJBGameInstance::IsInGameForNetworkError' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, NetworkObserverTask) == 0x0003B8, "Member 'UAJBGameInstance::NetworkObserverTask' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, LoadingScreenManagerClass) == 0x0003C0, "Member 'UAJBGameInstance::LoadingScreenManagerClass' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, PlayMode) == 0x0003C8, "Member 'UAJBGameInstance::PlayMode' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, BattleSettings) == 0x0003CC, "Member 'UAJBGameInstance::BattleSettings' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, ArcadeTimeManagerClass) == 0x0003D8, "Member 'UAJBGameInstance::ArcadeTimeManagerClass' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, ArcadeTimeManager) == 0x0003E0, "Member 'UAJBGameInstance::ArcadeTimeManager' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, CharacterInfoTable) == 0x0003E8, "Member 'UAJBGameInstance::CharacterInfoTable' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, ServerAliveInfo) == 0x0003F0, "Member 'UAJBGameInstance::ServerAliveInfo' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, MovieUploadRemainingNum) == 0x000404, "Member 'UAJBGameInstance::MovieUploadRemainingNum' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, MaxMovieUploadNum) == 0x000408, "Member 'UAJBGameInstance::MaxMovieUploadNum' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, IsValidShopId) == 0x00040C, "Member 'UAJBGameInstance::IsValidShopId' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, OnStopReplayRecording) == 0x000410, "Member 'UAJBGameInstance::OnStopReplayRecording' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, AMSystemObserverTask) == 0x000428, "Member 'UAJBGameInstance::AMSystemObserverTask' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, HighlightManager) == 0x000430, "Member 'UAJBGameInstance::HighlightManager' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, OfflineDefaultCustomData) == 0x000438, "Member 'UAJBGameInstance::OfflineDefaultCustomData' has a wrong offset!");
static_assert(offsetof(UAJBGameInstance, ExtraPPTable) == 0x000488, "Member 'UAJBGameInstance::ExtraPPTable' has a wrong offset!");
...
public:
	...
	void AJBIPGetAddressResponse__DelegateSignature(const class FString& IP);
...
public:
	...
	void AJBIcmpPingResponse__DelegateSignature(bool Result);
...
static_assert(sizeof(UAJBInGameCharaMoveComponent) == 0x000770, "Wrong size on UAJBInGameCharaMoveComponent");
...
class UAJBInGameIndoorVolumeComponent final : public UBoxComponent
{
public:
	static class UClass* StaticClass()
	{
...
// 0x0000 (0x0328 - 0x0328)
class AAJBInGamePlacementBase final : public AActor
{
public:
	void PostInitializeComponentsBP();
	void PreInitializeComponentsBP();
...
class AAJBInGamePlayerState final : public APlayerState
{
public:
...
// 0x0000 (0x0328 - 0x0328)
class AAJBInGameProp final : public AAJBInGameEnviroment
{
public:
	static class UClass* StaticClass()
	{
...
public:
	...
	EInGameServerStatus                           StatusID;                                          // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsEnableRedis;                                    // 0x0045(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsInitializedNPC;                                 // 0x0046(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsRequestStopProcess;                             // 0x0047(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAJBGameInstance*                       RefAJBGameInstance;                                // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         DG_STATUS_ExpireSeconds;                           // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAJBInGameServerInfo) == 0x000058, "Wrong size on UAJBInGameServerInfo");
...
static_assert(offsetof(UAJBInGameServerInfo, StatusID) == 0x000044, "Member 'UAJBInGameServerInfo::StatusID' has a wrong offset!");
static_assert(offsetof(UAJBInGameServerInfo, bIsEnableRedis) == 0x000045, "Member 'UAJBInGameServerInfo::bIsEnableRedis' has a wrong offset!");
static_assert(offsetof(UAJBInGameServerInfo, bIsInitializedNPC) == 0x000046, "Member 'UAJBInGameServerInfo::bIsInitializedNPC' has a wrong offset!");
static_assert(offsetof(UAJBInGameServerInfo, bIsRequestStopProcess) == 0x000047, "Member 'UAJBInGameServerInfo::bIsRequestStopProcess' has a wrong offset!");
static_assert(offsetof(UAJBInGameServerInfo, RefAJBGameInstance) == 0x000048, "Member 'UAJBInGameServerInfo::RefAJBGameInstance' has a wrong offset!");
static_assert(offsetof(UAJBInGameServerInfo, DG_STATUS_ExpireSeconds) == 0x000050, "Member 'UAJBInGameServerInfo::DG_STATUS_ExpireSeconds' has a wrong offset!");

// Class AJB.AJBInGameSkillComponent
// 0x0020 (0x0110 - 0x00F0)
class UAJBInGameSkillComponent final : public UActorComponent
{
public:
...
class UAJBInGameSkillWidget final : public UAJBUserWidget
{
public:
...
// 0x0000 (0x00F0 - 0x00F0)
class UAJBInGameSpeedTreeWindBlower final : public UActorComponent
{
public:
...
// 0x0008 (0x0330 - 0x0328)
class AAJBInGameStand final : public AActor
{
public:
...
static_assert(sizeof(AAJBInGameStand) == 0x000330, "Wrong size on AAJBInGameStand");
...
// 0x0000 (0x0590 - 0x0590)
class UAJBInGameVolumeDetectionComponent final : public UBoxComponent
{
public:
	static class UClass* StaticClass()
	{
...
// 0x0000 (0x0328 - 0x0328)
class AAJBInGameWindow final : public AAJBInGameEnviroment
{
public:
...
// 0x0000 (0x0028 - 0x0028)
class IAJBInputUIInterface final : public IInterface
{
public:
	bool IsModeless();
...
static_assert(alignof(IAJBInputUIInterface) == 0x000008, "Wrong alignment on IAJBInputUIInterface");
static_assert(sizeof(IAJBInputUIInterface) == 0x000028, "Wrong size on IAJBInputUIInterface");
...
public:
	...
	void AJBIPSetAddressResponse__DelegateSignature();
...
// 0x0008 (0x0330 - 0x0328)
class AAJBMessageManager final : public AActor
{
public:
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, bool IsNewCard, EAJBBNCardStatus CardStatus, bool RegistBNCS);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, const struct FAJBLogoutReward& Reward);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, const TArray<struct FAJBAnnouncement>& Announcements);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, const struct FAJBGameResult& GameResultData);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, EAJBRewardReceivingStatus ReceiveingStatus, const struct FAJBGetRewardsResponse& GetRewards);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, bool bIsNewUser, EAJBBNCardStatus CardStatus, bool RegistBNCS);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, bool bIsNewUser, EAJBBNCardStatus CardStatus, bool bIsNotLocked);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, int32 CurrentSection, int32 TotalSection);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, int32 RemaingNum);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, int32 NextExtendSpan);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
public:
	...
	void AJBNetAPIResponse__DelegateSignature(EAJBNetAPIResult Result, const struct FAJBGachaID& GachaID);
	void HttpError(int32 Code, const class FString& ErrorMessage);
...
class AAJBOnlineBeaconClient final : public AOnlineBeaconClient
{
public:
...
class AAJBOutGamePlayerController final : public AAJBPlayerControllerBase
{
public:
	static class UClass* StaticClass()
	{
...
class AAJBOutGameProxy final : public AActor
{
public:
...
public:
	...
	class UNetMessage* CreateNetMessage_Tenpo_GameSetting(int32 NPCNum, int32 PlayMode);
...
static_assert(sizeof(UAJBParamFile) == 0x000090, "Wrong size on UAJBParamFile");
...
static_assert(sizeof(UAJBParamRepos) == 0x000078, "Wrong size on UAJBParamRepos");
...
class AAJBPlayerCameraManager final : public APlayerCameraManager
{
public:
	static class UClass* StaticClass()
	{
...
public:
	...
	int32                                         DefaultAddCredit;                                  // 0x00F0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableDebugDisplay;                               // 0x00F4(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsForLocationTest;                                // 0x00F5(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsForNegotiations;                                // 0x00F6(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsForElectricalTest;                              // 0x00F7(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 NetErrorComebackMap;                               // 0x00F8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         EMoneyPrice;                                       // 0x0108(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseDebugClosedArcadeTimeSchedule;                 // 0x010C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10D[0x3];                                      // 0x010D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAJBDevCloseTimeInfo>           DevCloseTimes;                                     // 0x0110(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	bool                                          bEnableSkinCustomDebug;                            // 0x0120(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_121[0x3];                                      // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         AutoPlayTestMode;                                  // 0x0124(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 MUCHAServerLocalIP;                                // 0x0128(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 NetworkInterfaceName;                              // 0x0138(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ContentRouterGatewayIP;                            // 0x0148(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         DedicatedServerOnlineBeaconPortOffset;             // 0x0158(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableEMoneyBrandTest;                            // 0x015C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceDevelopEMoneyServer;                         // 0x015D(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnablePromotionMode;                              // 0x015E(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15F[0x1];                                      // 0x015F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 RewardPercentURL;                                  // 0x0160(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         JoystickPlayLow;                                   // 0x0170(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         JoystickPlayHigh;                                  // 0x0174(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         JoystickRightPlayHighInGame;                       // 0x0178(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         JoystickLeftPlayHighInGame;                        // 0x017C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseYButtonAsVictoryShot;                          // 0x0180(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_181[0x3];                                      // 0x0181(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         VictoryShotComporess;                              // 0x0184(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableInputCountForDev;                           // 0x0188(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_189[0x7];                                      // 0x0189(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   StartUpNextLevel;                                  // 0x0190(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ScreenShotMaxUploadSpeed;                          // 0x0198(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         HighlightMaxUploadSpeed;                           // 0x019C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         HighlightDataSize;                                 // 0x01A0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HighlightUploadCheckInterval;                      // 0x01A4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowShopSupportWebSiteInfo;                       // 0x01A8(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAvailableAllCharacters;                           // 0x01A9(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAvailableAllStages;                               // 0x01AA(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AB[0x5];                                      // 0x01AB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  DebugTags;                                         // 0x01B0(0x0020)(Edit, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAJBSettings) == 0x0001D0, "Wrong size on UAJBSettings");
...
static_assert(offsetof(UAJBSettings, DefaultAddCredit) == 0x0000F0, "Member 'UAJBSettings::DefaultAddCredit' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bEnableDebugDisplay) == 0x0000F4, "Member 'UAJBSettings::bEnableDebugDisplay' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bIsForLocationTest) == 0x0000F5, "Member 'UAJBSettings::bIsForLocationTest' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bIsForNegotiations) == 0x0000F6, "Member 'UAJBSettings::bIsForNegotiations' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bIsForElectricalTest) == 0x0000F7, "Member 'UAJBSettings::bIsForElectricalTest' has a wrong offset!");
static_assert(offsetof(UAJBSettings, NetErrorComebackMap) == 0x0000F8, "Member 'UAJBSettings::NetErrorComebackMap' has a wrong offset!");
static_assert(offsetof(UAJBSettings, EMoneyPrice) == 0x000108, "Member 'UAJBSettings::EMoneyPrice' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bUseDebugClosedArcadeTimeSchedule) == 0x00010C, "Member 'UAJBSettings::bUseDebugClosedArcadeTimeSchedule' has a wrong offset!");
static_assert(offsetof(UAJBSettings, DevCloseTimes) == 0x000110, "Member 'UAJBSettings::DevCloseTimes' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bEnableSkinCustomDebug) == 0x000120, "Member 'UAJBSettings::bEnableSkinCustomDebug' has a wrong offset!");
static_assert(offsetof(UAJBSettings, AutoPlayTestMode) == 0x000124, "Member 'UAJBSettings::AutoPlayTestMode' has a wrong offset!");
static_assert(offsetof(UAJBSettings, MUCHAServerLocalIP) == 0x000128, "Member 'UAJBSettings::MUCHAServerLocalIP' has a wrong offset!");
static_assert(offsetof(UAJBSettings, NetworkInterfaceName) == 0x000138, "Member 'UAJBSettings::NetworkInterfaceName' has a wrong offset!");
static_assert(offsetof(UAJBSettings, ContentRouterGatewayIP) == 0x000148, "Member 'UAJBSettings::ContentRouterGatewayIP' has a wrong offset!");
static_assert(offsetof(UAJBSettings, DedicatedServerOnlineBeaconPortOffset) == 0x000158, "Member 'UAJBSettings::DedicatedServerOnlineBeaconPortOffset' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bEnableEMoneyBrandTest) == 0x00015C, "Member 'UAJBSettings::bEnableEMoneyBrandTest' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bForceDevelopEMoneyServer) == 0x00015D, "Member 'UAJBSettings::bForceDevelopEMoneyServer' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bEnablePromotionMode) == 0x00015E, "Member 'UAJBSettings::bEnablePromotionMode' has a wrong offset!");
static_assert(offsetof(UAJBSettings, RewardPercentURL) == 0x000160, "Member 'UAJBSettings::RewardPercentURL' has a wrong offset!");
static_assert(offsetof(UAJBSettings, JoystickPlayLow) == 0x000170, "Member 'UAJBSettings::JoystickPlayLow' has a wrong offset!");
static_assert(offsetof(UAJBSettings, JoystickPlayHigh) == 0x000174, "Member 'UAJBSettings::JoystickPlayHigh' has a wrong offset!");
static_assert(offsetof(UAJBSettings, JoystickRightPlayHighInGame) == 0x000178, "Member 'UAJBSettings::JoystickRightPlayHighInGame' has a wrong offset!");
static_assert(offsetof(UAJBSettings, JoystickLeftPlayHighInGame) == 0x00017C, "Member 'UAJBSettings::JoystickLeftPlayHighInGame' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bUseYButtonAsVictoryShot) == 0x000180, "Member 'UAJBSettings::bUseYButtonAsVictoryShot' has a wrong offset!");
static_assert(offsetof(UAJBSettings, VictoryShotComporess) == 0x000184, "Member 'UAJBSettings::VictoryShotComporess' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bEnableInputCountForDev) == 0x000188, "Member 'UAJBSettings::bEnableInputCountForDev' has a wrong offset!");
static_assert(offsetof(UAJBSettings, StartUpNextLevel) == 0x000190, "Member 'UAJBSettings::StartUpNextLevel' has a wrong offset!");
static_assert(offsetof(UAJBSettings, ScreenShotMaxUploadSpeed) == 0x000198, "Member 'UAJBSettings::ScreenShotMaxUploadSpeed' has a wrong offset!");
static_assert(offsetof(UAJBSettings, HighlightMaxUploadSpeed) == 0x00019C, "Member 'UAJBSettings::HighlightMaxUploadSpeed' has a wrong offset!");
static_assert(offsetof(UAJBSettings, HighlightDataSize) == 0x0001A0, "Member 'UAJBSettings::HighlightDataSize' has a wrong offset!");
static_assert(offsetof(UAJBSettings, HighlightUploadCheckInterval) == 0x0001A4, "Member 'UAJBSettings::HighlightUploadCheckInterval' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bShowShopSupportWebSiteInfo) == 0x0001A8, "Member 'UAJBSettings::bShowShopSupportWebSiteInfo' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bAvailableAllCharacters) == 0x0001A9, "Member 'UAJBSettings::bAvailableAllCharacters' has a wrong offset!");
static_assert(offsetof(UAJBSettings, bAvailableAllStages) == 0x0001AA, "Member 'UAJBSettings::bAvailableAllStages' has a wrong offset!");
static_assert(offsetof(UAJBSettings, DebugTags) == 0x0001B0, "Member 'UAJBSettings::DebugTags' has a wrong offset!");
...
class UAJBStringTableManagerComponent final : public UActorComponent
{
public:
