...
class IFlowStateInterface final : public IInterface
{
public:
...
static_assert(alignof(IFlowStateInterface) == 0x000008, "Wrong alignment on IFlowStateInterface");
static_assert(sizeof(IFlowStateInterface) == 0x000028, "Wrong size on IFlowStateInterface");
...
// 0x0000 (0x0028 - 0x0028)
class ITransitionInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(ITransitionInterface) == 0x000008, "Wrong alignment on ITransitionInterface");
static_assert(sizeof(ITransitionInterface) == 0x000028, "Wrong size on ITransitionInterface");
