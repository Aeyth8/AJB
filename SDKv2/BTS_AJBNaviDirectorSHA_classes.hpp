...
public:
	...
	TArray<class ABP_AJBInGameAIImaginaryCharacter_C*> AllEnemies;                                        // 0x00F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance)
...
public:
	...
	void FindMostApproachableEnemy(class ABP_AJBInGameAIImaginaryCharacter_C** Character, class UNavigationPath** NavigationPath_0);
	...
	void FindMostApproachableBurningActor(class AActor** Actor, class UNavigationPath** NavigationPath_0);
...
static_assert(sizeof(UBTS_AJBNaviDirectorSHA_C) == 0x0002A8, "Wrong size on UBTS_AJBNaviDirectorSHA_C");
...
static_assert(offsetof(UBTS_AJBNaviDirectorSHA_C, AllEnemies) == 0x0000F0, "Member 'UBTS_AJBNaviDirectorSHA_C::AllEnemies' has a wrong offset!");
