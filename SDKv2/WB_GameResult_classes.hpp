...
public:
	...
	struct FAJBGameRecord                         TestGameRecord;                                    // 0x0548(0x0038)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          bOutputGameresultLog;                              // 0x0580(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bOutputRequestParamLog;                            // 0x0581(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_582[0x2];                                      // 0x0582(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OutputLogTime;                                     // 0x0584(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         BonusPointDelayTime;                               // 0x0588(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         DisplayBeforeExp;                                  // 0x058C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         DisplayNextExp;                                    // 0x0590(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         DisplayAfterExp;                                   // 0x0594(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FAJBGameRewardInfo>             CachedParsedLevelUpRewardInfos;                    // 0x0598(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FAJBGameRewardInfo>             CachedParsedAchieveRewardInfos;                    // 0x05A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	EGameResultUIInnerState                       CurrentState;                                      // 0x05B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5B9[0x7];                                      // 0x05B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAJBLimitedAchievements                CachedParsedLimitedAchievement;                    // 0x05C0(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UWB_LimitedAchievement_C*               RefLimitedAchievement;                             // 0x05F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UWB_CommonWIndow_S_C*                   WaitOtherPlayers;                                  // 0x05F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             EmoteIconBG;                                       // 0x0600(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             IconBG;                                            // 0x0608(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UWB_CharacterAchievement_C*             RefCharacterAchievement;                           // 0x0610(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         PreGameTicket;                                     // 0x0618(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_61C[0x4];                                      // 0x061C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWB_GameResultTicket_C*                 RefGameResultTicket;                               // 0x0620(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UWB_GameResultBonusPoint_C*>     BonusPoints;                                       // 0x0628(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FFlowStateHandler                      AchievementStateHandler;                           // 0x0638(0x0060)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UWB_PairAchievement_C*                  RefPairAchievement;                                // 0x0698(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         VictoryCountLimitForDisplayingCharaAchievementWindow; // 0x06A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6A4[0x4];                                      // 0x06A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWB_ChallengeEventProgressWindow_C*     RefChallengeEventProgress;                         // 0x06A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWB_GameResult_C) == 0x0006B0, "Wrong size on UWB_GameResult_C");
...
static_assert(offsetof(UWB_GameResult_C, bOutputGameresultLog) == 0x000580, "Member 'UWB_GameResult_C::bOutputGameresultLog' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, bOutputRequestParamLog) == 0x000581, "Member 'UWB_GameResult_C::bOutputRequestParamLog' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, OutputLogTime) == 0x000584, "Member 'UWB_GameResult_C::OutputLogTime' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, BonusPointDelayTime) == 0x000588, "Member 'UWB_GameResult_C::BonusPointDelayTime' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, DisplayBeforeExp) == 0x00058C, "Member 'UWB_GameResult_C::DisplayBeforeExp' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, DisplayNextExp) == 0x000590, "Member 'UWB_GameResult_C::DisplayNextExp' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, DisplayAfterExp) == 0x000594, "Member 'UWB_GameResult_C::DisplayAfterExp' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, CachedParsedLevelUpRewardInfos) == 0x000598, "Member 'UWB_GameResult_C::CachedParsedLevelUpRewardInfos' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, CachedParsedAchieveRewardInfos) == 0x0005A8, "Member 'UWB_GameResult_C::CachedParsedAchieveRewardInfos' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, CurrentState) == 0x0005B8, "Member 'UWB_GameResult_C::CurrentState' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, CachedParsedLimitedAchievement) == 0x0005C0, "Member 'UWB_GameResult_C::CachedParsedLimitedAchievement' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, RefLimitedAchievement) == 0x0005F0, "Member 'UWB_GameResult_C::RefLimitedAchievement' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, WaitOtherPlayers) == 0x0005F8, "Member 'UWB_GameResult_C::WaitOtherPlayers' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, EmoteIconBG) == 0x000600, "Member 'UWB_GameResult_C::EmoteIconBG' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, IconBG) == 0x000608, "Member 'UWB_GameResult_C::IconBG' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, RefCharacterAchievement) == 0x000610, "Member 'UWB_GameResult_C::RefCharacterAchievement' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, PreGameTicket) == 0x000618, "Member 'UWB_GameResult_C::PreGameTicket' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, RefGameResultTicket) == 0x000620, "Member 'UWB_GameResult_C::RefGameResultTicket' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, BonusPoints) == 0x000628, "Member 'UWB_GameResult_C::BonusPoints' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, AchievementStateHandler) == 0x000638, "Member 'UWB_GameResult_C::AchievementStateHandler' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, RefPairAchievement) == 0x000698, "Member 'UWB_GameResult_C::RefPairAchievement' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, VictoryCountLimitForDisplayingCharaAchievementWindow) == 0x0006A0, "Member 'UWB_GameResult_C::VictoryCountLimitForDisplayingCharaAchievementWindow' has a wrong offset!");
static_assert(offsetof(UWB_GameResult_C, RefChallengeEventProgress) == 0x0006A8, "Member 'UWB_GameResult_C::RefChallengeEventProgress' has a wrong offset!");
