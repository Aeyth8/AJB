...
public:
	void OnIntervalSetupCompleted__DelegateSignature(float BaseRadius, const struct FVector& BaseLocation, bool DisableReduction);
	void OnIntervalCompleted__DelegateSignature();
	void OnRestart__DelegateSignature(float BaseRadius, const struct FVector& BaseLocation);
