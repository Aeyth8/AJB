...
public:
	...
	class UWB_VictoryShotResult_C*                WB_VictoryShotResult;                              // 0x0370(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class FName                                   FlowStep;                                          // 0x0378(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EAJBPadIconType                               PadType;                                           // 0x0380(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_381[0x3];                                      // 0x0381(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PosingTime;                                        // 0x0384(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         ShotTime;                                          // 0x0388(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         FinishTime;                                        // 0x038C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CurrentTime;                                       // 0x0390(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_394[0x4];                                      // 0x0394(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	UMulticastDelegateProperty_                   OnTimeupPosingDispatcher;                          // 0x0398(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	UMulticastDelegateProperty_                   OnTimeupShotDispatcher;                            // 0x03A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	UMulticastDelegateProperty_                   OnTimeupVictoryShotDispatcher;                     // 0x03B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	UMulticastDelegateProperty_                   OnFinishedFlashAnimDispatcher;                     // 0x03C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                          bPlayFlash;                                        // 0x03D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bUploadSuccess;                                    // 0x03D9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)

public:
	void OnTimeupPosingDispatcher__DelegateSignature();
	void OnTimeupShotDispatcher__DelegateSignature();
	void OnTimeupVictoryShotDispatcher__DelegateSignature();
	void OnFinishedFlashAnimDispatcher__DelegateSignature();
...
static_assert(sizeof(UWB_VictoryShot_C) == 0x0003E0, "Wrong size on UWB_VictoryShot_C");
...
static_assert(offsetof(UWB_VictoryShot_C, WB_VictoryShotResult) == 0x000370, "Member 'UWB_VictoryShot_C::WB_VictoryShotResult' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, FlowStep) == 0x000378, "Member 'UWB_VictoryShot_C::FlowStep' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, PadType) == 0x000380, "Member 'UWB_VictoryShot_C::PadType' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, PosingTime) == 0x000384, "Member 'UWB_VictoryShot_C::PosingTime' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, ShotTime) == 0x000388, "Member 'UWB_VictoryShot_C::ShotTime' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, FinishTime) == 0x00038C, "Member 'UWB_VictoryShot_C::FinishTime' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, CurrentTime) == 0x000390, "Member 'UWB_VictoryShot_C::CurrentTime' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, OnTimeupPosingDispatcher) == 0x000398, "Member 'UWB_VictoryShot_C::OnTimeupPosingDispatcher' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, OnTimeupShotDispatcher) == 0x0003A8, "Member 'UWB_VictoryShot_C::OnTimeupShotDispatcher' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, OnTimeupVictoryShotDispatcher) == 0x0003B8, "Member 'UWB_VictoryShot_C::OnTimeupVictoryShotDispatcher' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, OnFinishedFlashAnimDispatcher) == 0x0003C8, "Member 'UWB_VictoryShot_C::OnFinishedFlashAnimDispatcher' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, bPlayFlash) == 0x0003D8, "Member 'UWB_VictoryShot_C::bPlayFlash' has a wrong offset!");
static_assert(offsetof(UWB_VictoryShot_C, bUploadSuccess) == 0x0003D9, "Member 'UWB_VictoryShot_C::bUploadSuccess' has a wrong offset!");
