...
public:
	...
	struct FAJBCharacterInfo                      CallFunc_GetCharacterInfoByCharaIndex_Out;         // 0x0058(0x00E0)()
	bool                                          CallFunc_GetCharacterInfoByCharaIndex_ReturnValue; // 0x0138(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(WB_Reward_C_TryGetCharacterName) == 0x000008, "Wrong alignment on WB_Reward_C_TryGetCharacterName");
static_assert(sizeof(WB_Reward_C_TryGetCharacterName) == 0x000140, "Wrong size on WB_Reward_C_TryGetCharacterName");
...
static_assert(offsetof(WB_Reward_C_TryGetCharacterName, CallFunc_GetCharacterInfoByCharaIndex_ReturnValue) == 0x000138, "Member 'WB_Reward_C_TryGetCharacterName::CallFunc_GetCharacterInfoByCharaIndex_ReturnValue' has a wrong offset!");
