...
// Function WB_TournamentMode_PlayerDetail.WB_TournamentMode_PlayerDetail_C.OnSelected__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct WB_TournamentMode_PlayerDetail_C_OnSelected__DelegateSignature final
{
public:
...
static_assert(alignof(WB_TournamentMode_PlayerDetail_C_OnSelected__DelegateSignature) == 0x000004, "Wrong alignment on WB_TournamentMode_PlayerDetail_C_OnSelected__DelegateSignature");
static_assert(sizeof(WB_TournamentMode_PlayerDetail_C_OnSelected__DelegateSignature) == 0x000004, "Wrong size on WB_TournamentMode_PlayerDetail_C_OnSelected__DelegateSignature");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_OnSelected__DelegateSignature, PlayerID_0) == 0x000000, "Member 'WB_TournamentMode_PlayerDetail_C_OnSelected__DelegateSignature::PlayerID_0' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_Conv_ByteToInt_ReturnValue1;              // 0x0280(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_284[0x4];                                      // 0x0284(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo1;                  // 0x0288(0x0050)(HasGetValueTypeHash)
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo2;                  // 0x02D8(0x0050)(HasGetValueTypeHash)
	...
	bool                                          CallFunc_NotEqual_ByteByte_ReturnValue;            // 0x0364(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NotEqual_ByteByte_ReturnValue1;           // 0x0365(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_SwitchEnum1_CmpSuccess;                     // 0x0366(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NotEqual_ByteByte_ReturnValue2;           // 0x0367(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NotEqual_ByteByte_ReturnValue3;           // 0x0368(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_NotEqual_ByteByte_ReturnValue4;           // 0x0369(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_36A[0x6];                                      // 0x036A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                Temp_object_Variable;                              // 0x0370(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             K2Node_DynamicCast_AsTexture_2D;                   // 0x0378(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo3;                  // 0x0390(0x0050)(HasGetValueTypeHash)
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo4;                  // 0x03E0(0x0050)(HasGetValueTypeHash)
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate;              // 0x0430(0x0010)(ZeroConstructor, NoDestructor)
	struct FSlateFontInfo                         K2Node_MakeStruct_SlateFontInfo5;                  // 0x0440(0x0050)(HasGetValueTypeHash)
};
...
static_assert(sizeof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail) == 0x000490, "Wrong size on WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail");
...
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_GetCharacterInfoByCharaIndex_ReturnValue) == 0x000260, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_GetCharacterInfoByCharaIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_Conv_StringToText_ReturnValue) == 0x000268, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_Conv_ByteToInt_ReturnValue1) == 0x000280, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_Conv_ByteToInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_MakeStruct_SlateFontInfo1) == 0x000288, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_MakeStruct_SlateFontInfo1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_MakeStruct_SlateFontInfo2) == 0x0002D8, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_MakeStruct_SlateFontInfo2' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_Event_MyGeometry) == 0x000328, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_Event_InDeltaTime) == 0x000360, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x000364, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_NotEqual_ByteByte_ReturnValue1) == 0x000365, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_NotEqual_ByteByte_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_SwitchEnum1_CmpSuccess) == 0x000366, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_SwitchEnum1_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_NotEqual_ByteByte_ReturnValue2) == 0x000367, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_NotEqual_ByteByte_ReturnValue2' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_NotEqual_ByteByte_ReturnValue3) == 0x000368, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_NotEqual_ByteByte_ReturnValue3' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, CallFunc_NotEqual_ByteByte_ReturnValue4) == 0x000369, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::CallFunc_NotEqual_ByteByte_ReturnValue4' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, Temp_object_Variable) == 0x000370, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_DynamicCast_AsTexture_2D) == 0x000378, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_DynamicCast_AsTexture_2D' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_DynamicCast_bSuccess) == 0x000380, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_CustomEvent_Loaded) == 0x000388, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_CustomEvent_Loaded' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_MakeStruct_SlateFontInfo3) == 0x000390, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_MakeStruct_SlateFontInfo3' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_MakeStruct_SlateFontInfo4) == 0x0003E0, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_MakeStruct_SlateFontInfo4' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_CreateDelegate_OutputDelegate) == 0x000430, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail, K2Node_MakeStruct_SlateFontInfo5) == 0x000440, "Member 'WB_TournamentMode_PlayerDetail_C_ExecuteUbergraph_WB_TournamentMode_PlayerDetail::K2Node_MakeStruct_SlateFontInfo5' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_MakeLiteralInt_ReturnValue1;              // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Conv_IntToFloat_ReturnValue2;             // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Conv_IntToFloat_ReturnValue5;             // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue1;                // 0x0068(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FWidgetTransform                       K2Node_MakeStruct_WidgetTransform;                 // 0x0070(0x001C)(NoDestructor)
};
static_assert(alignof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar) == 0x000004, "Wrong alignment on WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar");
static_assert(sizeof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar) == 0x00008C, "Wrong size on WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar");
...
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_MakeVector2D_ReturnValue) == 0x00000C, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_MakeLiteralInt_ReturnValue) == 0x000014, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_MakeLiteralInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_MakeLiteralInt_ReturnValue1) == 0x000018, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_MakeLiteralInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00001C, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000020, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000024, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue) == 0x000028, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Conv_IntToFloat_ReturnValue2) == 0x00002C, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Conv_IntToFloat_ReturnValue2' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Divide_FloatFloat_ReturnValue1) == 0x000030, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Divide_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue1) == 0x000034, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Conv_IntToFloat_ReturnValue3) == 0x000038, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Conv_IntToFloat_ReturnValue3' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Conv_IntToFloat_ReturnValue4) == 0x00003C, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Conv_IntToFloat_ReturnValue4' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue2) == 0x000040, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue2' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue3) == 0x000044, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue3' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Divide_FloatFloat_ReturnValue2) == 0x000048, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Divide_FloatFloat_ReturnValue2' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Conv_IntToFloat_ReturnValue5) == 0x00004C, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Conv_IntToFloat_ReturnValue5' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue4) == 0x000050, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue4' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Divide_FloatFloat_ReturnValue3) == 0x000054, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Divide_FloatFloat_ReturnValue3' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue5) == 0x000058, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue5' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue6) == 0x00005C, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue6' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_MapRangeClamped_ReturnValue) == 0x000060, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_MapRangeClamped_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_Add_FloatFloat_ReturnValue7) == 0x000064, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_Add_FloatFloat_ReturnValue7' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, CallFunc_MakeVector2D_ReturnValue1) == 0x000068, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::CallFunc_MakeVector2D_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar, K2Node_MakeStruct_WidgetTransform) == 0x000070, "Member 'WB_TournamentMode_PlayerDetail_C_UpdateHPAndAPBar::K2Node_MakeStruct_WidgetTransform' has a wrong offset!");
