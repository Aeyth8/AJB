...
public:
	...
	ESkillAffecterState                           State;                                             // 0x0338(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void OnRep_State();
	void ChangeState(ESkillAffecterState NewState);
