...
void IBI_AdditionalAP_C::Initialize()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "Initialize");
...
void IBI_AdditionalAP_C::GetValue(int32* AAPValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "GetValue");
...
void IBI_AdditionalAP_C::Consume(int32 Damage, int32* LeftDamage, int32* BeforeValue, int32* AfterValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "Consume");
...
void IBI_AdditionalAP_C::GetValueMax(int32* AAPValueMax)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "GetValueMax");
...
void IBI_AdditionalAP_C::OnConsumed(int32 BeforeValue, int32 AfterValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "OnConsumed");
...
void IBI_AdditionalAP_C::GetParticleTagBlocked(struct FGameplayTag* ParticleTag)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "GetParticleTagBlocked");
...
void IBI_AdditionalAP_C::AddValue(int32 Point, class AActor* Causer)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "AddValue");
...
void IBI_AdditionalAP_C::GetSETagBlocked(struct FGameplayTag* SETag)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "GetSETagBlocked");
...
void IBI_AdditionalAP_C::ConsumeSimulated(int32 Damage, int32* LeftDamage, int32* BeforeValue, int32* AfterValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "ConsumeSimulated");
...
void IBI_AdditionalAP_C::ChangeParticleVisibility(bool NewVisibility)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BI_AdditionalAP_C", "ChangeParticleVisibility");
