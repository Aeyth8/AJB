...
// Function BP_AJBInGameSeparateStand.BP_AJBInGameSeparateStand_C.OnSeparateMaxSpeedChanged__DelegateSignature
// 0x0001 (0x0001 - 0x0000)
struct BP_AJBInGameSeparateStand_C_OnSeparateMaxSpeedChanged__DelegateSignature final
{
public:
	ESeparateStandFlyingState                     SeparateFlyingState_0;                             // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_AJBInGameSeparateStand_C_OnSeparateMaxSpeedChanged__DelegateSignature) == 0x000001, "Wrong alignment on BP_AJBInGameSeparateStand_C_OnSeparateMaxSpeedChanged__DelegateSignature");
static_assert(sizeof(BP_AJBInGameSeparateStand_C_OnSeparateMaxSpeedChanged__DelegateSignature) == 0x000001, "Wrong size on BP_AJBInGameSeparateStand_C_OnSeparateMaxSpeedChanged__DelegateSignature");
static_assert(offsetof(BP_AJBInGameSeparateStand_C_OnSeparateMaxSpeedChanged__DelegateSignature, SeparateFlyingState_0) == 0x000000, "Member 'BP_AJBInGameSeparateStand_C_OnSeparateMaxSpeedChanged__DelegateSignature::SeparateFlyingState_0' has a wrong offset!");
