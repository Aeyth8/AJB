...
static_assert(offsetof(BI_AJBInterface_C_CheckTargetSelf, bTarget) == 0x00000A, "Member 'BI_AJBInterface_C_CheckTargetSelf::bTarget' has a wrong offset!");
...
static_assert(sizeof(BI_AJBInterface_C_AJBDamage) == 0x000040, "Wrong size on BI_AJBInterface_C_AJBDamage");
...
static_assert(sizeof(BI_AJBInterface_C_OwnHitParam) == 0x000018, "Wrong size on BI_AJBInterface_C_OwnHitParam");
...
static_assert(sizeof(BI_AJBInterface_C_DamageOverlapped) == 0x000020, "Wrong size on BI_AJBInterface_C_DamageOverlapped");
...
static_assert(offsetof(BI_AJBInterface_C_CheckDisableDamage, bDisableDamage) == 0x000008, "Member 'BI_AJBInterface_C_CheckDisableDamage::bDisableDamage' has a wrong offset!");
...
static_assert(offsetof(BI_AJBInterface_C_CheckDisablePassive, bDisablePassive) == 0x000010, "Member 'BI_AJBInterface_C_CheckDisablePassive::bDisablePassive' has a wrong offset!");
...
static_assert(alignof(BI_AJBInterface_C_IgnoreTrace) == 0x000001, "Wrong alignment on BI_AJBInterface_C_IgnoreTrace");
static_assert(sizeof(BI_AJBInterface_C_IgnoreTrace) == 0x000001, "Wrong size on BI_AJBInterface_C_IgnoreTrace");
static_assert(offsetof(BI_AJBInterface_C_IgnoreTrace, bIgnore) == 0x000000, "Member 'BI_AJBInterface_C_IgnoreTrace::bIgnore' has a wrong offset!");
