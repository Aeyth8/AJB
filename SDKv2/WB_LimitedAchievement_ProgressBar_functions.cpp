...
// Function WB_LimitedAchievement_ProgressBar.WB_LimitedAchievement_ProgressBar_C.OnFinishedAnimDispatcher__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWB_LimitedAchievement_ProgressBar_C::OnFinishedAnimDispatcher__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_LimitedAchievement_ProgressBar_C", "OnFinishedAnimDispatcher__DelegateSignature");
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FAJBAchievementInfo              TargetInfo                                             (BlueprintVisible, BlueprintReadOnly, Parm)
