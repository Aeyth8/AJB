...
void UBPC_ObjectLoader_C::OnLoadedObjectDispatcher__DelegateSignature(const class FString& LoadId, class UObject* LoadedObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPC_ObjectLoader_C", "OnLoadedObjectDispatcher__DelegateSignature");

	Params::BPC_ObjectLoader_C_OnLoadedObjectDispatcher__DelegateSignature Parms{};
...
void UBPC_ObjectLoader_C::OnLoadedClassDispatcher__DelegateSignature(const class FString& LoadId, class UClass* LoadObjClass)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPC_ObjectLoader_C", "OnLoadedClassDispatcher__DelegateSignature");

	Params::BPC_ObjectLoader_C_OnLoadedClassDispatcher__DelegateSignature Parms{};
...
// Parameters:
// struct FST_ObjectClassLoadInfo          LoadObjClassInfo                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
...
// (HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FST_ObjectLoadInfo               LoadObjInfo                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
