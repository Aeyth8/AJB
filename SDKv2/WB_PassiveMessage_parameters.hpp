...
public:
	...
	bool                                          CallFunc_K2_IsTimerActiveHandle_ReturnValue;       // 0x00D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage, CallFunc_Array_Length_ReturnValue1) == 0x000058, "Member 'WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage::CallFunc_Array_Length_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage, K2Node_MakeStruct_FormatArgumentData) == 0x000060, "Member 'WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0000A0, "Member 'WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage, K2Node_MakeArray_Array) == 0x0000A8, "Member 'WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage, CallFunc_Format_ReturnValue) == 0x0000B8, "Member 'WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage::CallFunc_Format_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage, CallFunc_K2_IsTimerActiveHandle_ReturnValue) == 0x0000D9, "Member 'WB_PassiveMessage_C_ExecuteUbergraph_WB_PassiveMessage::CallFunc_K2_IsTimerActiveHandle_ReturnValue' has a wrong offset!");
