...
// Function BP_AJBDamageAreaLocal.BP_AJBDamageAreaLocal_C.OnPreAnnounceReduction__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct BP_AJBDamageAreaLocal_C_OnPreAnnounceReduction__DelegateSignature final
{
public:
...
static_assert(alignof(BP_AJBDamageAreaLocal_C_OnPreAnnounceReduction__DelegateSignature) == 0x000004, "Wrong alignment on BP_AJBDamageAreaLocal_C_OnPreAnnounceReduction__DelegateSignature");
static_assert(sizeof(BP_AJBDamageAreaLocal_C_OnPreAnnounceReduction__DelegateSignature) == 0x000004, "Wrong size on BP_AJBDamageAreaLocal_C_OnPreAnnounceReduction__DelegateSignature");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_OnPreAnnounceReduction__DelegateSignature, Timespan_Until_Start_Reduction) == 0x000000, "Member 'BP_AJBDamageAreaLocal_C_OnPreAnnounceReduction__DelegateSignature::Timespan_Until_Start_Reduction' has a wrong offset!");

// Function BP_AJBDamageAreaLocal.BP_AJBDamageAreaLocal_C.OnProceedReduction__DelegateSignature
// 0x0014 (0x0014 - 0x0000)
struct BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature final
{
public:
...
static_assert(alignof(BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature) == 0x000004, "Wrong alignment on BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature");
static_assert(sizeof(BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature) == 0x000014, "Wrong size on BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature, Radius) == 0x000000, "Member 'BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature::Radius' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature, Location) == 0x000004, "Member 'BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature::Location' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature, RemainingTime) == 0x000010, "Member 'BP_AJBDamageAreaLocal_C_OnProceedReduction__DelegateSignature::RemainingTime' has a wrong offset!");

// Function BP_AJBDamageAreaLocal.BP_AJBDamageAreaLocal_C.OnCompletedSetup__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature final
{
public:
	float                                         Radius;                                            // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                Location;                                          // 0x0004(0x000C)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature) == 0x000004, "Wrong alignment on BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature");
static_assert(sizeof(BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature) == 0x000010, "Wrong size on BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature, Radius) == 0x000000, "Member 'BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature::Radius' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature, Location) == 0x000004, "Member 'BP_AJBDamageAreaLocal_C_OnCompletedSetup__DelegateSignature::Location' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_GetAJBInGameGameState_bIsValid1;          // 0x0292(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_293[0x5];                                      // 0x0293(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class AAJBInGameGameState*                    CallFunc_GetAJBInGameGameState_ReturnValue1;       // 0x0298(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimespan                              CallFunc_GetElapsedInGameTimespan_ReturnValue1;    // 0x02A0(0x0008)(NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetTotalSeconds_ReturnValue3;             // 0x02A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Round_ReturnValue1;                       // 0x02AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                  CallFunc_GetDebugTags_ReturnValue3;                // 0x02B0(0x0020)()
	bool                                          CallFunc_HasTag_ReturnValue3;                      // 0x02D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          Temp_bool_Has_Been_Initd_Variable3;                // 0x02D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2D9[0x7];                                      // 0x02D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate5;             // 0x02E0(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_NotEqual_IntInt_ReturnValue;              // 0x02F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2F1[0x7];                                      // 0x02F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  CallFunc_GetDebugTags_ReturnValue4;                // 0x02F8(0x0020)()
	bool                                          CallFunc_HasTag_ReturnValue4;                      // 0x0318(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_IsClosed_Variable3;                      // 0x0319(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal) == 0x000320, "Wrong size on BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal");
...
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_GetAJBInGameGameState_bIsValid1) == 0x000292, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_GetAJBInGameGameState_bIsValid1' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_GetAJBInGameGameState_ReturnValue1) == 0x000298, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_GetAJBInGameGameState_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_GetElapsedInGameTimespan_ReturnValue1) == 0x0002A0, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_GetElapsedInGameTimespan_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_GetTotalSeconds_ReturnValue3) == 0x0002A8, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_GetTotalSeconds_ReturnValue3' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_Round_ReturnValue1) == 0x0002AC, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_Round_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_GetDebugTags_ReturnValue3) == 0x0002B0, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_GetDebugTags_ReturnValue3' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_HasTag_ReturnValue3) == 0x0002D0, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_HasTag_ReturnValue3' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_Subtract_IntInt_ReturnValue) == 0x0002D4, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, Temp_bool_Has_Been_Initd_Variable3) == 0x0002D8, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::Temp_bool_Has_Been_Initd_Variable3' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, K2Node_CreateDelegate_OutputDelegate5) == 0x0002E0, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::K2Node_CreateDelegate_OutputDelegate5' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_NotEqual_IntInt_ReturnValue) == 0x0002F0, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_GetDebugTags_ReturnValue4) == 0x0002F8, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_GetDebugTags_ReturnValue4' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, CallFunc_HasTag_ReturnValue4) == 0x000318, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::CallFunc_HasTag_ReturnValue4' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal, Temp_bool_IsClosed_Variable3) == 0x000319, "Member 'BP_AJBDamageAreaLocal_C_ExecuteUbergraph_BP_AJBDamageAreaLocal::Temp_bool_IsClosed_Variable3' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_GetAJBInGameGameState_bIsValid;           // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_Exists_bExists;                           // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction) == 0x000030, "Wrong size on BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction");
...
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_GetAJBInGameGameState_bIsValid) == 0x000005, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_GetAJBInGameGameState_bIsValid' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_GetAJBInGameGameState_ReturnValue) == 0x000008, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_GetAJBInGameGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_GetElapsedInGameTimespan_ReturnValue) == 0x000010, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_GetElapsedInGameTimespan_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_Exists_bExists) == 0x000018, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_Exists_bExists' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_GetTotalSeconds_ReturnValue) == 0x00001C, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_GetTotalSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_Round_ReturnValue) == 0x000020, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_Round_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, K2Node_Select_Default) == 0x000024, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_Subtract_IntInt_ReturnValue) == 0x000028, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction, CallFunc_Max_ReturnValue) == 0x00002C, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilStartReduction::CallFunc_Max_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction) == 0x000038, "Wrong size on BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction");
...
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_GetAJBInGameGameState_bIsValid) == 0x000005, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_GetAJBInGameGameState_bIsValid' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_GetAJBInGameGameState_ReturnValue) == 0x000008, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_GetAJBInGameGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_Exists_bExists) == 0x000010, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_Exists_bExists' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_GetElapsedInGameTimespan_ReturnValue) == 0x000018, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_GetElapsedInGameTimespan_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_GetTotalSeconds_ReturnValue) == 0x000020, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_GetTotalSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_Round_ReturnValue) == 0x000024, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_Round_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, K2Node_Select_Default) == 0x000028, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_Subtract_IntInt_ReturnValue) == 0x00002C, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction, CallFunc_Max_ReturnValue) == 0x000030, "Member 'BP_AJBDamageAreaLocal_C_GetTimeSecondsUntilCompleteReduction::CallFunc_Max_ReturnValue' has a wrong offset!");
