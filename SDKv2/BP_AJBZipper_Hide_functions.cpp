...
void ABP_AJBZipper_Hide_C::OnReceiveDamageServer(int32 Damage, const struct FGameplayTag& DamageType, class AActor* DamageCauser, bool bRemainHP, bool bDamageIsCut, bool bNotUseCollision)
{
	static class UFunction* Func = nullptr;
