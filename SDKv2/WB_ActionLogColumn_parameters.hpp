...
// Function WB_ActionLogColumn.WB_ActionLogColumn_C.OnFinishedVisibleTime__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature final
{
public:
...
static_assert(alignof(WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature) == 0x000008, "Wrong alignment on WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature");
static_assert(sizeof(WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature) == 0x000008, "Wrong size on WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature");
static_assert(offsetof(WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature, SelfLogColumn) == 0x000000, "Member 'WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature::SelfLogColumn' has a wrong offset!");
