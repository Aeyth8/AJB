...
public:
	...
	class UAJBTextBlock*                          Txt_PpNum;                                         // 0x0300(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWB_Aura_C*                             WB_Aura;                                           // 0x0308(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	int32                                         PpNum;                                             // 0x0314(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CreditNum;                                         // 0x0318(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         BonusNunm;                                         // 0x031C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FWidgetTransform                       PpTranceForm;                                      // 0x0320(0x001C)(Edit, BlueprintVisible, NoDestructor)
	bool                                          EnableActive;                                      // 0x033C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          PreviousEnableActve;                               // 0x033D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bCheckLimitAdditionalCredit;                       // 0x033E(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          bLimit3000PP;                                      // 0x033F(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bLimitPossesionPP;                                 // 0x0340(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UWB_PpBuy_Button_1Credit_C) == 0x000348, "Wrong size on UWB_PpBuy_Button_1Credit_C");
...
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, Txt_PpNum) == 0x000300, "Member 'UWB_PpBuy_Button_1Credit_C::Txt_PpNum' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, WB_Aura) == 0x000308, "Member 'UWB_PpBuy_Button_1Credit_C::WB_Aura' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, AuraOffset) == 0x000310, "Member 'UWB_PpBuy_Button_1Credit_C::AuraOffset' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, PpNum) == 0x000314, "Member 'UWB_PpBuy_Button_1Credit_C::PpNum' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, CreditNum) == 0x000318, "Member 'UWB_PpBuy_Button_1Credit_C::CreditNum' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, BonusNunm) == 0x00031C, "Member 'UWB_PpBuy_Button_1Credit_C::BonusNunm' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, PpTranceForm) == 0x000320, "Member 'UWB_PpBuy_Button_1Credit_C::PpTranceForm' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, EnableActive) == 0x00033C, "Member 'UWB_PpBuy_Button_1Credit_C::EnableActive' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, PreviousEnableActve) == 0x00033D, "Member 'UWB_PpBuy_Button_1Credit_C::PreviousEnableActve' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, bCheckLimitAdditionalCredit) == 0x00033E, "Member 'UWB_PpBuy_Button_1Credit_C::bCheckLimitAdditionalCredit' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, bLimit3000PP) == 0x00033F, "Member 'UWB_PpBuy_Button_1Credit_C::bLimit3000PP' has a wrong offset!");
static_assert(offsetof(UWB_PpBuy_Button_1Credit_C, bLimitPossesionPP) == 0x000340, "Member 'UWB_PpBuy_Button_1Credit_C::bLimitPossesionPP' has a wrong offset!");
