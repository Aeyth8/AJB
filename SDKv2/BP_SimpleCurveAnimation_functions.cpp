...
void UBP_SimpleCurveAnimation_C::OnStartAnim__DelegateSignature(class UBP_SimpleCurveAnimation_C* AnimComponent, bool bReverse)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SimpleCurveAnimation_C", "OnStartAnim__DelegateSignature");

	Params::BP_SimpleCurveAnimation_C_OnStartAnim__DelegateSignature Parms{};
...
void UBP_SimpleCurveAnimation_C::OnFinishAnim__DelegateSignature(class UBP_SimpleCurveAnimation_C* AnimComponent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SimpleCurveAnimation_C", "OnFinishAnim__DelegateSignature");

	Params::BP_SimpleCurveAnimation_C_OnFinishAnim__DelegateSignature Parms{};
