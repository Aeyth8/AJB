...
public:
	...
	struct FVector2D                              CallFunc_GetDesiredSize_ReturnValue;               // 0x0050(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_ClampScreenPosition_NewPosition;          // 0x0058(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_GetDesiredSize_ReturnValue1;              // 0x006C(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_CustomEvent_BarValue;                       // 0x00A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_Time;                           // 0x00AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_BreakVector2D_X2;                         // 0x00D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_BreakVector2D_Y2;                         // 0x00D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_NewScale;                       // 0x00DC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_MaxMinScale;                    // 0x00E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_OffsetLocation;                 // 0x00E4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue1;                // 0x00F8(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue2;                // 0x0100(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue3;                // 0x0108(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue4;                // 0x0110(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchInteger1_CmpSuccess;                  // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         K2Node_CustomEvent_HpValue;                        // 0x01B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_ApValue;                        // 0x01B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_CPValue;                        // 0x01B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_CustomEvent_MaxCPValue;                     // 0x01BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_CustomEvent_SpValue;                        // 0x01C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_PlayModeIsPair_ReturnValue;               // 0x01C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         CallFunc_FClamp_ReturnValue2;                      // 0x01F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue5;                // 0x01F4(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UTexture2D*                             CallFunc_GetAJBPadIcon_KeyAssignConsidering_OutTexture; // 0x0200(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_Divide_Vector2DFloat_ReturnValue1;        // 0x0220(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_Subtract_Vector2DVector2D_ReturnValue;    // 0x0228(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTransform                             K2Node_CustomEvent_FollowTargetTransform;          // 0x0230(0x0030)(IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo) == 0x000290, "Wrong size on WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo");
...
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_bIsOutViewPosition) == 0x000004, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_bIsOutViewPosition' has a wrong offset!");
...
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_GetOrthant_Orthant) == 0x000010, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_GetOrthant_Orthant' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_Event_MyGeometry) == 0x000014, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_Event_InDeltaTime) == 0x00004C, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_GetDesiredSize_ReturnValue) == 0x000050, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_GetDesiredSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_ClampScreenPosition_NewPosition) == 0x000058, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_ClampScreenPosition_NewPosition' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Divide_Vector2DFloat_ReturnValue) == 0x000060, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Divide_Vector2DFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_GetViewportScale_ReturnValue) == 0x000068, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_GetViewportScale_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_GetDesiredSize_ReturnValue1) == 0x00006C, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_GetDesiredSize_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakVector2D_X) == 0x000074, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakVector2D_Y) == 0x000078, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x00007C, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_DynamicCast_AsCanvas_Panel_Slot) == 0x000080, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_DynamicCast_AsCanvas_Panel_Slot' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_DynamicCast_bSuccess) == 0x000088, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Subtract_FloatFloat_ReturnValue1) == 0x00008C, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Subtract_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_FMax_ReturnValue) == 0x000090, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Lerp_ReturnValue) == 0x000094, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Lerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MakeVector2D_ReturnValue) == 0x000098, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_GetDynamicMaterial_ReturnValue) == 0x0000A0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_BarValue) == 0x0000A8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_BarValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_Time) == 0x0000AC, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_Time' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Conv_FloatToText_ReturnValue) == 0x0000B0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Conv_FloatToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Greater_FloatFloat_ReturnValue) == 0x0000C8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakVector2D_X1) == 0x0000CC, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakVector2D_X1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakVector2D_Y1) == 0x0000D0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakVector2D_Y1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakVector2D_X2) == 0x0000D4, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakVector2D_X2' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakVector2D_Y2) == 0x0000D8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakVector2D_Y2' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_NewScale) == 0x0000DC, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_NewScale' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_MaxMinScale) == 0x0000E0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_MaxMinScale' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_OffsetLocation) == 0x0000E4, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_OffsetLocation' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x0000E8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_SwitchInteger_CmpSuccess) == 0x0000EC, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_SwitchInteger_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MapRangeClamped_ReturnValue) == 0x0000F0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MapRangeClamped_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MapRangeClamped_ReturnValue1) == 0x0000F4, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MapRangeClamped_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MakeVector2D_ReturnValue1) == 0x0000F8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MakeVector2D_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MakeVector2D_ReturnValue2) == 0x000100, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MakeVector2D_ReturnValue2' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MakeVector2D_ReturnValue3) == 0x000108, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MakeVector2D_ReturnValue3' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MakeVector2D_ReturnValue4) == 0x000110, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MakeVector2D_ReturnValue4' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_SwitchInteger1_CmpSuccess) == 0x000118, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_SwitchInteger1_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_HpValue) == 0x0001B0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_HpValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_ApValue) == 0x0001B4, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_ApValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_CPValue) == 0x0001B8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_CPValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_MaxCPValue) == 0x0001BC, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_MaxCPValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_SpValue) == 0x0001C0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_SpValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_PlayModeIsPair_ReturnValue) == 0x0001C4, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_PlayModeIsPair_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Add_IntInt_ReturnValue) == 0x0001C8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Conv_IntToText_ReturnValue) == 0x0001D0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_FClamp_ReturnValue) == 0x0001E8, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_FClamp_ReturnValue1) == 0x0001EC, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_FClamp_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_FClamp_ReturnValue2) == 0x0001F0, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_FClamp_ReturnValue2' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_MakeVector2D_ReturnValue5) == 0x0001F4, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_MakeVector2D_ReturnValue5' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_GetAJBPadIcon_KeyAssignConsidering_OutTexture) == 0x000200, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_GetAJBPadIcon_KeyAssignConsidering_OutTexture' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_GetDynamicMaterial_ReturnValue1) == 0x000208, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_GetDynamicMaterial_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_MakeStruct_LinearColor) == 0x000210, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_MakeStruct_LinearColor' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Divide_Vector2DFloat_ReturnValue1) == 0x000220, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Divide_Vector2DFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_Subtract_Vector2DVector2D_ReturnValue) == 0x000228, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_Subtract_Vector2DVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, K2Node_CustomEvent_FollowTargetTransform) == 0x000230, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::K2Node_CustomEvent_FollowTargetTransform' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakTransform_Location) == 0x000260, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakTransform_Rotation) == 0x00026C, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo, CallFunc_BreakTransform_Scale) == 0x000278, "Member 'WB_UI_FollowPairInfo_C_ExecuteUbergraph_WB_UI_FollowPairInfo::CallFunc_BreakTransform_Scale' has a wrong offset!");
...
public:
	...
	int32                                         SpValue;                                           // 0x0010(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WB_UI_FollowPairInfo_C_SetPairHPAndAPAndCPAndSP) == 0x000014, "Wrong size on WB_UI_FollowPairInfo_C_SetPairHPAndAPAndCPAndSP");
...
static_assert(offsetof(WB_UI_FollowPairInfo_C_SetPairHPAndAPAndCPAndSP, SpValue) == 0x000010, "Member 'WB_UI_FollowPairInfo_C_SetPairHPAndAPAndCPAndSP::SpValue' has a wrong offset!");
