...
// Function BP_AJBInGameSceneDirectorComponent.BP_AJBInGameSceneDirectorComponent_C.OnBeginCut__DelegateSignature
// 0x0002 (0x0002 - 0x0000)
struct BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature final
{
public:
...
static_assert(alignof(BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature) == 0x000001, "Wrong alignment on BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature");
static_assert(sizeof(BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature) == 0x000002, "Wrong size on BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature");
static_assert(offsetof(BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature, CurrentCut_0) == 0x000000, "Member 'BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature::CurrentCut_0' has a wrong offset!");
static_assert(offsetof(BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature, BeforeCut_0) == 0x000001, "Member 'BP_AJBInGameSceneDirectorComponent_C_OnBeginCut__DelegateSignature::BeforeCut_0' has a wrong offset!");

// Function BP_AJBInGameSceneDirectorComponent.BP_AJBInGameSceneDirectorComponent_C.OnEndCut__DelegateSignature
// 0x0002 (0x0002 - 0x0000)
struct BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature final
{
public:
	uint8                                         CurrentCut_0;                                      // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature) == 0x000001, "Wrong alignment on BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature");
static_assert(sizeof(BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature) == 0x000002, "Wrong size on BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature");
static_assert(offsetof(BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature, CurrentCut_0) == 0x000000, "Member 'BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature::CurrentCut_0' has a wrong offset!");
static_assert(offsetof(BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature, NextCut) == 0x000001, "Member 'BP_AJBInGameSceneDirectorComponent_C_OnEndCut__DelegateSignature::NextCut' has a wrong offset!");
