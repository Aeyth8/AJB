...
void ABP_AJBDamageAffecterBase_C::OnNotifyResultServer__DelegateSignature(int32 KillNum)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AJBDamageAffecterBase_C", "OnNotifyResultServer__DelegateSignature");

	Params::BP_AJBDamageAffecterBase_C_OnNotifyResultServer__DelegateSignature Parms{};
...
void ABP_AJBDamageAffecterBase_C::AreaInterval(class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBDamageAffecterBase_C::GetScaledRadius(float* Radius_0)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBDamageAffecterBase_C::GetPoliticDamage(int32* Damage)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBDamageAffecterBase_C::AddToMultipleLocations(const struct FVector& NewLocation)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBDamageAffecterBase_C::CheckAreaInEvenOne(class AActor* Target, TArray<struct FVector>& Locations, const struct FRotator& Rotation, float Radius_0, float Length_0, int32 PartitionNum_0, bool* bTarget)
{
	static class UFunction* Func = nullptr;
