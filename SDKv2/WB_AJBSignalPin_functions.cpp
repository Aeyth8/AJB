...
// Function WB_AJBSignalPin.WB_AJBSignalPin_C.OnClickRemoveButton__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWB_AJBSignalPin_C::OnClickRemoveButton__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_AJBSignalPin_C", "OnClickRemoveButton__DelegateSignature");
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector                          PinLocation3D_0                                        (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
