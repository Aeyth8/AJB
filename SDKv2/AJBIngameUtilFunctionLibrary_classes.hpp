...
public:
	...
	static void GenerateHitEffect_Local(const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FRotator& HitRotation, const struct FGameplayTag& DamageType, bool bCharacter, bool bLeftAP, bool bHeadShot, EPhysicalSurface SurfaceType, bool bBlockedByAAP, const struct FGameplayTag& ParticleTagBlockedByAAP, class UObject* __WorldContext);
	...
	static void CalcDamage(class AActor* DamagedActor, class AActor* DamageCauser, int32 BaseDamage, float CuttingRateByBlocking, bool bPenetrateAP, bool bIgnoreCalcAttackRate, class UObject* __WorldContext, int32* DamageForHPAP, int32* DamageForAAP, int32* CutDamage, bool* bRemainHP, bool* bDamageIsCutByAAP);
	...
	static void IsPair(class AActor* FirstActor, class AActor* SecondActor, class UObject* __WorldContext, bool* bPairCharacter);
