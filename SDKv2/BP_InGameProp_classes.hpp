...
class ABP_InGameProp_C final : public AAJBInGameProp
{
public:
...
public:
	void OnPropDamaged__DelegateSignature(class AActor* DamagedActor, int32 DamageForHPAP, int32 DamageForAAP, int32 CutDamage, const struct FGameplayTag& DamageType, int32 SerialNumber, EDamagePriority DamagePriority, float AttackDistance, class AActor* DamageCauser, bool bWithSeparetedStandAttack, bool bHitEnemysSeparatedStand, bool bPenetrateAP);
