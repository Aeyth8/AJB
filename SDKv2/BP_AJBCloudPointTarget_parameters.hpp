...
public:
	...
	TDelegate<void(const struct FGameplayTag& AddCondition)> K2Node_CreateDelegate_OutputDelegate;              // 0x0098(0x0010)(ZeroConstructor, NoDestructor)
	...
	bool                                          CallFunc_MatchesAnyTags_ReturnValue;               // 0x0110(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(BP_AJBCloudPointTarget_C_ExecuteUbergraph_BP_AJBCloudPointTarget) == 0x000118, "Wrong size on BP_AJBCloudPointTarget_C_ExecuteUbergraph_BP_AJBCloudPointTarget");
...
static_assert(offsetof(BP_AJBCloudPointTarget_C_ExecuteUbergraph_BP_AJBCloudPointTarget, CallFunc_MakeLiteralGameplayTagContainer_ReturnValue) == 0x0000F0, "Member 'BP_AJBCloudPointTarget_C_ExecuteUbergraph_BP_AJBCloudPointTarget::CallFunc_MakeLiteralGameplayTagContainer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBCloudPointTarget_C_ExecuteUbergraph_BP_AJBCloudPointTarget, CallFunc_MatchesAnyTags_ReturnValue) == 0x000110, "Member 'BP_AJBCloudPointTarget_C_ExecuteUbergraph_BP_AJBCloudPointTarget::CallFunc_MatchesAnyTags_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_AJBCloudPointTarget_C_OnPassiveAdded) == 0x000008, "Wrong size on BP_AJBCloudPointTarget_C_OnPassiveAdded");
