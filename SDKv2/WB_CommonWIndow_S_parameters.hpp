...
// Function WB_CommonWIndow_S.WB_CommonWIndow_S_C.OnFinishedConfirmDispatcher__DelegateSignature
// 0x0001 (0x0001 - 0x0000)
struct WB_CommonWIndow_S_C_OnFinishedConfirmDispatcher__DelegateSignature final
{
public:
...
static_assert(alignof(WB_CommonWIndow_S_C_OnFinishedConfirmDispatcher__DelegateSignature) == 0x000001, "Wrong alignment on WB_CommonWIndow_S_C_OnFinishedConfirmDispatcher__DelegateSignature");
static_assert(sizeof(WB_CommonWIndow_S_C_OnFinishedConfirmDispatcher__DelegateSignature) == 0x000001, "Wrong size on WB_CommonWIndow_S_C_OnFinishedConfirmDispatcher__DelegateSignature");
static_assert(offsetof(WB_CommonWIndow_S_C_OnFinishedConfirmDispatcher__DelegateSignature, Result) == 0x000000, "Member 'WB_CommonWIndow_S_C_OnFinishedConfirmDispatcher__DelegateSignature::Result' has a wrong offset!");
