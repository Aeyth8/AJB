...
void UBP_AJBCloseRangeSkill_C::OnBlocking(class AActor* BlockedActor, const struct FVector& HitLocation, float CuttingRate, bool bInvincible, bool bIsPenetration)
{
	static class UFunction* Func = nullptr;
...
void UBP_AJBCloseRangeSkill_C::OnTargetHit(class AActor* HitActor, const struct FVector& HitLocation, const struct FVector& HitNormal, EPhysicalSurface SurfaceType, bool bDisableDamage, bool bIsPenetration)
{
	static class UFunction* Func = nullptr;
...
void UBP_AJBCloseRangeSkill_C::OnHit(class AActor* HitActor, const struct FVector& HitLocation, const struct FVector& HitNormal, float CuttingRate, EPhysicalSurface SurfaceType, bool bDisableDamage, bool bInvincible, bool bIsPenetration)
{
	static class UFunction* Func = nullptr;
...
// (Net, NetReliable, NetMulticast, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector                          TargetDirection_0                                      (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_AJBCloseRangeSkill_C::MC_HitWait(class AActor* HitActor, const struct FVector& HitLocation, const struct FVector& HitNormal, float CuttingRate, EPhysicalSurface SurfaceType, bool bDisableDamage, bool bInvincible, bool bIsPenetration, bool bBlockedByAAP, bool bHeadShot)
{
	static class UFunction* Func = nullptr;
...
void UBP_AJBCloseRangeSkill_C::ROS_HitWait(class AActor* HitActor, const struct FVector& HitLocation, const struct FVector& HitNormal, float CuttingRate, EPhysicalSurface SurfaceType, bool bDisableDamage, bool bInvincible, int32 SerialNumber_0, bool bIsPenetration, bool bBlockedByAAP, bool bHeadShot)
{
	static class UFunction* Func = nullptr;
...
void UBP_AJBCloseRangeSkill_C::HitWait(class AActor* HitActor, const struct FVector& HitLocation, const struct FVector& HitNormal, float CuttingRate, EPhysicalSurface SurfaceType, bool bDisableDamage, bool bInvincible, bool bIsPenetration, bool bBlockedByAAP, bool bHeadShot)
{
	static class UFunction* Func = nullptr;
