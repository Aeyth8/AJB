...
// Parameters:
// class UWB_TestModeMenuItemValue_C*      ChangeMenuItem                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWB_TestModeMenuItemValue_C::OnChangeValue__DelegateSignature(class UWB_TestModeMenuItemValue_C* ChangeMenuItem)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_TestModeMenuItemValue_C", "OnChangeValue__DelegateSignature");

	Params::WB_TestModeMenuItemValue_C_OnChangeValue__DelegateSignature Parms{};

	Parms.ChangeMenuItem = ChangeMenuItem;
