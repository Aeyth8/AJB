...
public:
	...
	class AAJBInGameCharacter*                    K2Node_CustomEvent_MyCharacter;                    // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_CustomEvent_bHeadShot;                      // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_bFinishBlow;                    // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase) == 0x000018, "Wrong size on WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase");
...
static_assert(offsetof(WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase, K2Node_CustomEvent_DeltaSeconds) == 0x000004, "Member 'WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase::K2Node_CustomEvent_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase, K2Node_CustomEvent_MyCharacter) == 0x000008, "Member 'WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase::K2Node_CustomEvent_MyCharacter' has a wrong offset!");
static_assert(offsetof(WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase, K2Node_CustomEvent_bHeadShot) == 0x000010, "Member 'WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase::K2Node_CustomEvent_bHeadShot' has a wrong offset!");
static_assert(offsetof(WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase, K2Node_CustomEvent_bFinishBlow) == 0x000011, "Member 'WB_ReticleBase_C_ExecuteUbergraph_WB_ReticleBase::K2Node_CustomEvent_bFinishBlow' has a wrong offset!");
