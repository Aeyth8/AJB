...
public:
	...
	bool                                          K2Node_CustomEvent_bIsActive2;                     // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_bTriggeredByStand2;             // 0x0006(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FAJBActionInfo                         K2Node_MakeStruct_AJBActionInfo;                   // 0x0007(0x0002)(IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_bIsActive1;                     // 0x0009(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_bTriggeredByStand1;             // 0x000A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          K2Node_CustomEvent_bTriggeredByStand3;             // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          K2Node_CustomEvent_bTriggeredByStand4;             // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          K2Node_CustomEvent_bTriggeredByStand5;             // 0x0062(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AAJBInGameCharacterBase*                K2Node_DynamicCast_AsAJBIn_Game_Character_Base;    // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_CheckActive_bActive;                      // 0x008A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AAJBInGameCharacterBase*                K2Node_DynamicCast_AsAJBIn_Game_Character_Base2;   // 0x00C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsServer_ReturnValue1;                    // 0x00D3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase) == 0x0000D8, "Wrong size on BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase");
...
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_CustomEvent_bIsActive2) == 0x000005, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_CustomEvent_bIsActive2' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_CustomEvent_bTriggeredByStand2) == 0x000006, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_CustomEvent_bTriggeredByStand2' has a wrong offset!");
...
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_CustomEvent_bIsActive1) == 0x000009, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_CustomEvent_bIsActive1' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_CustomEvent_bTriggeredByStand1) == 0x00000A, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_CustomEvent_bTriggeredByStand1' has a wrong offset!");
...
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_Add_FloatFloat_ReturnValue) == 0x000028, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_CustomEvent_bTriggeredByStand3) == 0x000044, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_CustomEvent_bTriggeredByStand3' has a wrong offset!");
...
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_CustomEvent_bTriggeredByStand4) == 0x000050, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_CustomEvent_bTriggeredByStand4' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_DynamicCast_AsBP_AJBIn_Game_Player_Controller) == 0x000058, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_DynamicCast_AsBP_AJBIn_Game_Player_Controller' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_DynamicCast_bSuccess1) == 0x000060, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_IsLocalController_ReturnValue) == 0x000061, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_IsLocalController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_CustomEvent_bTriggeredByStand5) == 0x000062, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_CustomEvent_bTriggeredByStand5' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_Event_Operator) == 0x000068, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_Event_Operator' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_Event_Time) == 0x000070, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_Event_Time' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_Event_Timing) == 0x000074, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_Event_Timing' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_Event_bEnable) == 0x000075, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_Event_bEnable' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_Event_bOperatorIsEmpty) == 0x000076, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_Event_bOperatorIsEmpty' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_GetOwner_ReturnValue) == 0x000078, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_DynamicCast_AsAJBIn_Game_Character_Base) == 0x000080, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_DynamicCast_AsAJBIn_Game_Character_Base' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_DynamicCast_bSuccess2) == 0x000088, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_HasLocalSharedController_ReturnValue) == 0x000089, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_HasLocalSharedController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_CheckActive_bActive) == 0x00008A, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_CheckActive_bActive' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_Conv_BoolToString_ReturnValue) == 0x000090, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_Conv_BoolToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_GetOwner_ReturnValue1) == 0x0000A0, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_GetOwner_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_GetOwner_ReturnValue2) == 0x0000B8, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_GetOwner_ReturnValue2' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_HasLocalSharedController_ReturnValue1) == 0x0000C0, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_HasLocalSharedController_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_DynamicCast_AsAJBIn_Game_Character_Base2) == 0x0000C8, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_DynamicCast_AsAJBIn_Game_Character_Base2' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, K2Node_DynamicCast_bSuccess4) == 0x0000D0, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::K2Node_DynamicCast_bSuccess4' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_HasLocalSharedController_ReturnValue2) == 0x0000D1, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_HasLocalSharedController_ReturnValue2' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_IsDedicatedServer_ReturnValue) == 0x0000D2, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase, CallFunc_IsServer_ReturnValue1) == 0x0000D3, "Member 'BP_AJBActionBase_C_ExecuteUbergraph_BP_AJBActionBase::CallFunc_IsServer_ReturnValue1' has a wrong offset!");
