...
// Function BP_AJBZipper_InteractableBase.BP_AJBZipper_InteractableBase_C.OnOpenCloseAnimationFinished_0__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void ABP_AJBZipper_InteractableBase_C::OnOpenCloseAnimationFinished_0__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AJBZipper_InteractableBase_C", "OnOpenCloseAnimationFinished_0__DelegateSignature");
