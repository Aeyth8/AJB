...
public:
	void OnFinishedDelayForStartBehavior__DelegateSignature(class ABP_AJBInGameAIController_C* AI_Controller, class ABP_AJBDebugAIStartPoint_C* DebugAIStartPoint);
