...
void ABP_InGameProp_C::OnPropDamaged__DelegateSignature(class AActor* DamagedActor, int32 DamageForHPAP, int32 DamageForAAP, int32 CutDamage, const struct FGameplayTag& DamageType, int32 SerialNumber, EDamagePriority DamagePriority, float AttackDistance, class AActor* DamageCauser, bool bWithSeparetedStandAttack, bool bHitEnemysSeparatedStand, bool bPenetrateAP)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_InGameProp_C", "OnPropDamaged__DelegateSignature");

	Params::BP_InGameProp_C_OnPropDamaged__DelegateSignature Parms{};
...
void ABP_InGameProp_C::DamageOverlapped(class AActor* DamageCauser, const struct FVector& HitLocation, bool bPenetrating, const struct FGameplayTag& FactorTag)
{
	static class UFunction* Func = nullptr;
...
void ABP_InGameProp_C::CheckTargetSelf(class AActor* DamageCauser, bool bForDamageOverlap, bool bIgnoreMovableStand, bool* bTarget)
{
	static class UFunction* Func = nullptr;
...
void ABP_InGameProp_C::OwnHitParam(bool* bCharacter, bool* bLeftAP, struct FGameplayTag* ParticleTagBlockedByAAP, struct FGameplayTag* SETagBlockedByAAP)
{
	static class UFunction* Func = nullptr;
...
void ABP_InGameProp_C::CheckDisableDamage(class AActor* DamageCauser, bool* bDisableDamage)
{
	static class UFunction* Func = nullptr;
...
void ABP_InGameProp_C::CheckDisablePassive(class AActor* PassiveCauser, const struct FGameplayTag& PassiveTag, bool* bDisablePassive)
{
	static class UFunction* Func = nullptr;
...
void ABP_InGameProp_C::IgnoreTrace(bool* bIgnore)
{
	static class UFunction* Func = nullptr;
