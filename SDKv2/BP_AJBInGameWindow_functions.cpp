...
void ABP_AJBInGameWindow_C::DamageOverlapped(class AActor* DamageCauser, const struct FVector& HitLocation, bool bPenetrating, const struct FGameplayTag& FactorTag)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBInGameWindow_C::CheckDisablePassive(class AActor* PassiveCauser, const struct FGameplayTag& PassiveTag, bool* bDisablePassive)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBInGameWindow_C::CheckDisableDamage(class AActor* DamageCauser, bool* bDisableDamage)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBInGameWindow_C::OwnHitParam(bool* bCharacter, bool* bLeftAP, struct FGameplayTag* ParticleTagBlockedByAAP, struct FGameplayTag* SETagBlockedByAAP)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBInGameWindow_C::CheckTargetSelf(class AActor* DamageCauser, bool bForDamageOverlap, bool bIgnoreMovableStand, bool* bTarget)
{
	static class UFunction* Func = nullptr;
...
void ABP_AJBInGameWindow_C::IgnoreTrace(bool* bIgnore)
{
	static class UFunction* Func = nullptr;
