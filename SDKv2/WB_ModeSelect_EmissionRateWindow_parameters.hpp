...
public:
	...
	struct FAJBCharacterInfo                      CallFunc_GetCharacterInfoByCharaIndex_Out;         // 0x0020(0x00E0)()
	bool                                          CallFunc_GetCharacterInfoByCharaIndex_ReturnValue; // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WB_ModeSelect_EmissionRateWindow_C_TryGetCharacterName) == 0x000108, "Wrong size on WB_ModeSelect_EmissionRateWindow_C_TryGetCharacterName");
...
static_assert(offsetof(WB_ModeSelect_EmissionRateWindow_C_TryGetCharacterName, CallFunc_GetCharacterInfoByCharaIndex_ReturnValue) == 0x000100, "Member 'WB_ModeSelect_EmissionRateWindow_C_TryGetCharacterName::CallFunc_GetCharacterInfoByCharaIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_ModeSelect_EmissionRateWindow_C_TryGetCharacterName, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000101, "Member 'WB_ModeSelect_EmissionRateWindow_C_TryGetCharacterName::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
