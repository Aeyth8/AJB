...
void UWB_ActionLogColumn_C::OnFinishedVisibleTime__DelegateSignature(class UWB_ActionLogColumn_C* SelfLogColumn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_ActionLogColumn_C", "OnFinishedVisibleTime__DelegateSignature");

	Params::WB_ActionLogColumn_C_OnFinishedVisibleTime__DelegateSignature Parms{};
