...
struct WB_TournamentMode_Main_C_OnChangedWatcherPlayerDispatcher__DelegateSignature final
{
public:
...
static_assert(alignof(WB_TournamentMode_Main_C_OnChangedWatcherPlayerDispatcher__DelegateSignature) == 0x000004, "Wrong alignment on WB_TournamentMode_Main_C_OnChangedWatcherPlayerDispatcher__DelegateSignature");
static_assert(sizeof(WB_TournamentMode_Main_C_OnChangedWatcherPlayerDispatcher__DelegateSignature) == 0x000004, "Wrong size on WB_TournamentMode_Main_C_OnChangedWatcherPlayerDispatcher__DelegateSignature");
static_assert(offsetof(WB_TournamentMode_Main_C_OnChangedWatcherPlayerDispatcher__DelegateSignature, PlayerID) == 0x000000, "Member 'WB_TournamentMode_Main_C_OnChangedWatcherPlayerDispatcher__DelegateSignature::PlayerID' has a wrong offset!");

// Function WB_TournamentMode_Main.WB_TournamentMode_Main_C.OnReleasedTouchOnPlayer__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct WB_TournamentMode_Main_C_OnReleasedTouchOnPlayer__DelegateSignature final
{
public:
...
static_assert(alignof(WB_TournamentMode_Main_C_OnReleasedTouchOnPlayer__DelegateSignature) == 0x000008, "Wrong alignment on WB_TournamentMode_Main_C_OnReleasedTouchOnPlayer__DelegateSignature");
static_assert(sizeof(WB_TournamentMode_Main_C_OnReleasedTouchOnPlayer__DelegateSignature) == 0x000008, "Wrong size on WB_TournamentMode_Main_C_OnReleasedTouchOnPlayer__DelegateSignature");
static_assert(offsetof(WB_TournamentMode_Main_C_OnReleasedTouchOnPlayer__DelegateSignature, TouchedPlayerActor) == 0x000000, "Member 'WB_TournamentMode_Main_C_OnReleasedTouchOnPlayer__DelegateSignature::TouchedPlayerActor' has a wrong offset!");
