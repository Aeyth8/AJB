...
static_assert(sizeof(UBP_AJBPassiveSkillBase_C) == 0x000210, "Wrong size on UBP_AJBPassiveSkillBase_C");
...
static_assert(offsetof(UBP_AJBPassiveSkillBase_C, OnPassiveTimeUpDispatcher_All) == 0x0001F0, "Member 'UBP_AJBPassiveSkillBase_C::OnPassiveTimeUpDispatcher_All' has a wrong offset!");
static_assert(offsetof(UBP_AJBPassiveSkillBase_C, PropagationSource) == 0x000200, "Member 'UBP_AJBPassiveSkillBase_C::PropagationSource' has a wrong offset!");
static_assert(offsetof(UBP_AJBPassiveSkillBase_C, TryRemoveOnOwnerRequiem) == 0x000208, "Member 'UBP_AJBPassiveSkillBase_C::TryRemoveOnOwnerRequiem' has a wrong offset!");
static_assert(offsetof(UBP_AJBPassiveSkillBase_C, PlaySESafetyTime) == 0x00020C, "Member 'UBP_AJBPassiveSkillBase_C::PlaySESafetyTime' has a wrong offset!");
