...
static_assert(sizeof(UBP_AJBTrainingSequence_C) == 0x0001A0, "Wrong size on UBP_AJBTrainingSequence_C");
...
static_assert(offsetof(UBP_AJBTrainingSequence_C, LifeTimeSelectOperationType) == 0x000198, "Member 'UBP_AJBTrainingSequence_C::LifeTimeSelectOperationType' has a wrong offset!");
