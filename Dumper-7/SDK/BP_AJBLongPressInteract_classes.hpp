...
static_assert(sizeof(UBP_AJBLongPressInteract_C) == 0x000220, "Wrong size on UBP_AJBLongPressInteract_C");
...
static_assert(offsetof(UBP_AJBLongPressInteract_C, InteractMontageStand_StartSectionName) == 0x0001C0, "Member 'UBP_AJBLongPressInteract_C::InteractMontageStand_StartSectionName' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, InteractMontageStand_EndSectionName) == 0x0001C8, "Member 'UBP_AJBLongPressInteract_C::InteractMontageStand_EndSectionName' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, InteractMontageStand_EndSectionAnim) == 0x0001D0, "Member 'UBP_AJBLongPressInteract_C::InteractMontageStand_EndSectionAnim' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, bCompPlayStandMontage_EndSection) == 0x0001D8, "Member 'UBP_AJBLongPressInteract_C::bCompPlayStandMontage_EndSection' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, TraceLength) == 0x0001DC, "Member 'UBP_AJBLongPressInteract_C::TraceLength' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, ExtensionTimeToChangeNormalWalkingMode) == 0x0001E0, "Member 'UBP_AJBLongPressInteract_C::ExtensionTimeToChangeNormalWalkingMode' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, InteractMontageCharacter) == 0x0001E8, "Member 'UBP_AJBLongPressInteract_C::InteractMontageCharacter' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, InteractMontageCharacter_EndSectionName) == 0x0001F0, "Member 'UBP_AJBLongPressInteract_C::InteractMontageCharacter_EndSectionName' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, InteractMontageCharacter_EndSectionAnim) == 0x0001F8, "Member 'UBP_AJBLongPressInteract_C::InteractMontageCharacter_EndSectionAnim' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, bCompPlayCharacterMontage_EndSection) == 0x000200, "Member 'UBP_AJBLongPressInteract_C::bCompPlayCharacterMontage_EndSection' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, bShouldInputDisableDuringLongPress) == 0x000201, "Member 'UBP_AJBLongPressInteract_C::bShouldInputDisableDuringLongPress' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, bCustomSpawnInteractParticle) == 0x000202, "Member 'UBP_AJBLongPressInteract_C::bCustomSpawnInteractParticle' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, bInteractedForMovedCharacter) == 0x000203, "Member 'UBP_AJBLongPressInteract_C::bInteractedForMovedCharacter' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, bContinueAppearStandOnSucceed) == 0x000204, "Member 'UBP_AJBLongPressInteract_C::bContinueAppearStandOnSucceed' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, NextStateOnSucceed) == 0x000205, "Member 'UBP_AJBLongPressInteract_C::NextStateOnSucceed' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, bForceInactiveBasicSkillOnBegin) == 0x000206, "Member 'UBP_AJBLongPressInteract_C::bForceInactiveBasicSkillOnBegin' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, LongPressInteractSuccessSETag) == 0x000208, "Member 'UBP_AJBLongPressInteract_C::LongPressInteractSuccessSETag' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, StartVoiceTag) == 0x000210, "Member 'UBP_AJBLongPressInteract_C::StartVoiceTag' has a wrong offset!");
static_assert(offsetof(UBP_AJBLongPressInteract_C, SuccessVoiceTag) == 0x000218, "Member 'UBP_AJBLongPressInteract_C::SuccessVoiceTag' has a wrong offset!");
