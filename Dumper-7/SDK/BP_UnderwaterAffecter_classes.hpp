...
static_assert(sizeof(UBP_UnderwaterAffecter_C) == 0x000270, "Wrong size on UBP_UnderwaterAffecter_C");
...
static_assert(offsetof(UBP_UnderwaterAffecter_C, OnChangeNoseInServer) == 0x000258, "Member 'UBP_UnderwaterAffecter_C::OnChangeNoseInServer' has a wrong offset!");
static_assert(offsetof(UBP_UnderwaterAffecter_C, bIsDecreaseOxygenApneaTime) == 0x000268, "Member 'UBP_UnderwaterAffecter_C::bIsDecreaseOxygenApneaTime' has a wrong offset!");
static_assert(offsetof(UBP_UnderwaterAffecter_C, IsOwnerNPC) == 0x000269, "Member 'UBP_UnderwaterAffecter_C::IsOwnerNPC' has a wrong offset!");
static_assert(offsetof(UBP_UnderwaterAffecter_C, IsDeterminatedLastSurvivor) == 0x00026A, "Member 'UBP_UnderwaterAffecter_C::IsDeterminatedLastSurvivor' has a wrong offset!");
