...
static_assert(sizeof(UBTT_AJBTryInteract_C) == 0x000220, "Wrong size on UBTT_AJBTryInteract_C");
...
static_assert(offsetof(UBTT_AJBTryInteract_C, IsAllowedOpenedDoor) == 0x0001F8, "Member 'UBTT_AJBTryInteract_C::IsAllowedOpenedDoor' has a wrong offset!");
