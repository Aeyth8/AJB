...
static_assert(sizeof(ABP_AJBDamageImpulseBase_C) == 0x0004B0, "Wrong size on ABP_AJBDamageImpulseBase_C");
...
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bShouldHitOwnerAfterReflect) == 0x000450, "Member 'ABP_AJBDamageImpulseBase_C::bShouldHitOwnerAfterReflect' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, ReflectSkillTag) == 0x000458, "Member 'ABP_AJBDamageImpulseBase_C::ReflectSkillTag' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bCancelOnBecomeLastSurvivor) == 0x000460, "Member 'ABP_AJBDamageImpulseBase_C::bCancelOnBecomeLastSurvivor' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bBecomeLastSurvivor) == 0x000461, "Member 'ABP_AJBDamageImpulseBase_C::bBecomeLastSurvivor' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, ReflectCauser) == 0x000468, "Member 'ABP_AJBDamageImpulseBase_C::ReflectCauser' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bDamageByReflectCauser) == 0x000470, "Member 'ABP_AJBDamageImpulseBase_C::bDamageByReflectCauser' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bDisableSelfDamage) == 0x000471, "Member 'ABP_AJBDamageImpulseBase_C::bDisableSelfDamage' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, CriticalVoiceTag) == 0x000478, "Member 'ABP_AJBDamageImpulseBase_C::CriticalVoiceTag' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, RemoveVoiceTagIfStackOnAttackResult) == 0x000480, "Member 'ABP_AJBDamageImpulseBase_C::RemoveVoiceTagIfStackOnAttackResult' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bBlockVoiceTagIfStackOnAttackResult) == 0x000490, "Member 'ABP_AJBDamageImpulseBase_C::bBlockVoiceTagIfStackOnAttackResult' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, MostDamagedPhase) == 0x0004A0, "Member 'ABP_AJBDamageImpulseBase_C::MostDamagedPhase' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, DefaultDamagedPhase) == 0x0004A4, "Member 'ABP_AJBDamageImpulseBase_C::DefaultDamagedPhase' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, DamageDisplayAnimRate) == 0x0004A8, "Member 'ABP_AJBDamageImpulseBase_C::DamageDisplayAnimRate' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bRemoveOnOwnerProhibition) == 0x0004AC, "Member 'ABP_AJBDamageImpulseBase_C::bRemoveOnOwnerProhibition' has a wrong offset!");
static_assert(offsetof(ABP_AJBDamageImpulseBase_C, bRemoveOnOwnerNotActive) == 0x0004AD, "Member 'ABP_AJBDamageImpulseBase_C::bRemoveOnOwnerNotActive' has a wrong offset!");
