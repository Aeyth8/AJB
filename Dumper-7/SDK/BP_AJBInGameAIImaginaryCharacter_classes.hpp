...
static_assert(sizeof(ABP_AJBInGameAIImaginaryCharacter_C) == 0x000470, "Wrong size on ABP_AJBInGameAIImaginaryCharacter_C");
...
static_assert(offsetof(ABP_AJBInGameAIImaginaryCharacter_C, CharacterType) == 0x000468, "Member 'ABP_AJBInGameAIImaginaryCharacter_C::CharacterType' has a wrong offset!");
