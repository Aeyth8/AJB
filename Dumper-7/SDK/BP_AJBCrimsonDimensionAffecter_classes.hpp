...
static_assert(sizeof(ABP_AJBCrimsonDimensionAffecter_C) == 0x000468, "Wrong size on ABP_AJBCrimsonDimensionAffecter_C");
...
static_assert(offsetof(ABP_AJBCrimsonDimensionAffecter_C, DelayVisualUpdateTime) == 0x000460, "Member 'ABP_AJBCrimsonDimensionAffecter_C::DelayVisualUpdateTime' has a wrong offset!");
