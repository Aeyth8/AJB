...
static_assert(sizeof(BPF_UIStringUtil_C_GetAJBBattleTypeString) == 0x0000C0, "Wrong size on BPF_UIStringUtil_C_GetAJBBattleTypeString");
...
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBBattleTypeString, Temp_text_Variable4) == 0x000090, "Member 'BPF_UIStringUtil_C_GetAJBBattleTypeString::Temp_text_Variable4' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBBattleTypeString, K2Node_Select_Default) == 0x0000A8, "Member 'BPF_UIStringUtil_C_GetAJBBattleTypeString::K2Node_Select_Default' has a wrong offset!");
...
static_assert(alignof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText) == 0x000008, "Wrong alignment on BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText");
static_assert(sizeof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText) == 0x0000C0, "Wrong size on BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, Difficulty) == 0x000000, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::Difficulty' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, __WorldContext) == 0x000008, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::__WorldContext' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, Title) == 0x000010, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::Title' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, Level) == 0x000028, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::Level' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, DT_PvEGameDifficultyText) == 0x000040, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::DT_PvEGameDifficultyText' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, Temp_int_Array_Index_Variable) == 0x000048, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, Temp_int_Loop_Counter_Variable) == 0x00004C, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_Add_IntInt_ReturnValue) == 0x000050, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_GetDataTableRowNames_OutRowNames) == 0x000058, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_GetDataTableRowNames_OutRowNames' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_Array_Length_ReturnValue) == 0x000068, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_Array_Get_Item) == 0x000070, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_Less_IntInt_ReturnValue) == 0x000078, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_GetDataTableRowFromName_OutRow) == 0x000080, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0000B8, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000B9, "Member 'BPF_UIStringUtil_C_GetAJBPvEGameDifficultyText::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
