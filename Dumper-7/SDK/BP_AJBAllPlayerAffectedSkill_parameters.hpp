...
static_assert(sizeof(BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill) == 0x00001C, "Wrong size on BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill");
...
static_assert(offsetof(BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill, K2Node_Event_Value1) == 0x000008, "Member 'BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill::K2Node_Event_Value1' has a wrong offset!");
static_assert(offsetof(BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill, CallFunc_Add_FloatFloat_ReturnValue) == 0x00000C, "Member 'BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill, K2Node_Event_Value) == 0x000010, "Member 'BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill::K2Node_Event_Value' has a wrong offset!");
static_assert(offsetof(BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill, CallFunc_IsServer_ReturnValue) == 0x000014, "Member 'BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x000018, "Member 'BP_AJBAllPlayerAffectedSkill_C_ExecuteUbergraph_BP_AJBAllPlayerAffectedSkill::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(alignof(BP_AJBAllPlayerAffectedSkill_C_TimeRewind_Server) == 0x000004, "Wrong alignment on BP_AJBAllPlayerAffectedSkill_C_TimeRewind_Server");
static_assert(sizeof(BP_AJBAllPlayerAffectedSkill_C_TimeRewind_Server) == 0x000004, "Wrong size on BP_AJBAllPlayerAffectedSkill_C_TimeRewind_Server");
static_assert(offsetof(BP_AJBAllPlayerAffectedSkill_C_TimeRewind_Server, Value) == 0x000000, "Member 'BP_AJBAllPlayerAffectedSkill_C_TimeRewind_Server::Value' has a wrong offset!");
