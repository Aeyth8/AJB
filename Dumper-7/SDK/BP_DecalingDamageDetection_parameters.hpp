...
public:
	...
	class ABP_AJBInGameCharacter_C*               K2Node_Event_OperaatorCharacter;                   // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bNewFlag;                             // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           K2Node_Event_EffectTag2;                           // 0x0078(0x0008)(NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           K2Node_Event_SETag2;                               // 0x0080(0x0008)(NoDestructor, HasGetValueTypeHash)
	...
	int32                                         K2Node_Event_SerialNumber;                         // 0x00A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_IsEndured;                            // 0x00C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_C5[0x3];                                       // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAJBDamageDisplayParams                K2Node_Event_DamageDisplayParams;                  // 0x00C8(0x0030)(NoDestructor)
	struct FAJBDamageDisplayProperty              K2Node_Event_DamageDisplayProperty;                // 0x00F8(0x0003)(IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_MatchesAnyTags_ReturnValue;               // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection) == 0x000128, "Wrong size on BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_bInvalidDamage) == 0x000028, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_bInvalidDamage' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_OperatorCharacter1) == 0x000030, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_OperatorCharacter1' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_EffectTag1) == 0x000038, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_EffectTag1' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_SETag1) == 0x000040, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_SETag1' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_bNoDamage) == 0x000048, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_bNoDamage' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_OperatorCharacter) == 0x000050, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_OperatorCharacter' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_EffectTag) == 0x000058, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_EffectTag' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_SETag) == 0x000060, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_SETag' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_OperaatorCharacter) == 0x000068, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_OperaatorCharacter' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_bNewFlag) == 0x000070, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_bNewFlag' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_EffectTag2) == 0x000078, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_EffectTag2' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_SETag2) == 0x000080, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_SETag2' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamagedActor) == 0x000088, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamagedActor' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamageForHPAP) == 0x000090, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamageForHPAP' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamageForAAP) == 0x000094, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamageForAAP' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_CutDamage) == 0x000098, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_CutDamage' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamageType) == 0x0000A0, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamageType' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_SerialNumber) == 0x0000A8, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_SerialNumber' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamagePriority) == 0x0000AC, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamagePriority' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_AttackDistance) == 0x0000B0, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_AttackDistance' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamageCauser) == 0x0000B8, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamageCauser' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_WithSeparatedStandAttack) == 0x0000C0, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_WithSeparatedStandAttack' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_HitEnemysSeparatedStand) == 0x0000C1, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_HitEnemysSeparatedStand' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_bPenetrateAP) == 0x0000C2, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_bPenetrateAP' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_bNotUseCollision) == 0x0000C3, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_bNotUseCollision' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_IsEndured) == 0x0000C4, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_IsEndured' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamageDisplayParams) == 0x0000C8, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamageDisplayParams' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, K2Node_Event_DamageDisplayProperty) == 0x0000F8, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::K2Node_Event_DamageDisplayProperty' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, CallFunc_MakeLiteralGameplayTagContainer_ReturnValue) == 0x000100, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::CallFunc_MakeLiteralGameplayTagContainer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection, CallFunc_MatchesAnyTags_ReturnValue) == 0x000120, "Member 'BP_DecalingDamageDetection_C_ExecuteUbergraph_BP_DecalingDamageDetection::CallFunc_MatchesAnyTags_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_DecalingDamageDetection_C_AJBDamage) == 0x000078, "Wrong size on BP_DecalingDamageDetection_C_AJBDamage");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_AJBDamage, IsEndured) == 0x00003C, "Member 'BP_DecalingDamageDetection_C_AJBDamage::IsEndured' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_AJBDamage, DamageDisplayParams) == 0x000040, "Member 'BP_DecalingDamageDetection_C_AJBDamage::DamageDisplayParams' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_AJBDamage, DamageDisplayProperty) == 0x000070, "Member 'BP_DecalingDamageDetection_C_AJBDamage::DamageDisplayProperty' has a wrong offset!");
...
static_assert(sizeof(BP_DecalingDamageDetection_C_DamageOverlapped) == 0x000028, "Wrong size on BP_DecalingDamageDetection_C_DamageOverlapped");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_DamageOverlapped, bInvalidDamage) == 0x000020, "Member 'BP_DecalingDamageDetection_C_DamageOverlapped::bInvalidDamage' has a wrong offset!");
...
static_assert(sizeof(BP_DecalingDamageDetection_C_OwnHitParam) == 0x000020, "Wrong size on BP_DecalingDamageDetection_C_OwnHitParam");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_OwnHitParam, ParticleTagBlocked) == 0x000018, "Member 'BP_DecalingDamageDetection_C_OwnHitParam::ParticleTagBlocked' has a wrong offset!");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckTargetSelf, bIncludeSelf) == 0x00000A, "Member 'BP_DecalingDamageDetection_C_CheckTargetSelf::bIncludeSelf' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckTargetSelf, bAfterReflectShouldHitOwner) == 0x00000B, "Member 'BP_DecalingDamageDetection_C_CheckTargetSelf::bAfterReflectShouldHitOwner' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckTargetSelf, bTarget) == 0x00000C, "Member 'BP_DecalingDamageDetection_C_CheckTargetSelf::bTarget' has a wrong offset!");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckDisableDamage, bIgnoreSelf) == 0x000008, "Member 'BP_DecalingDamageDetection_C_CheckDisableDamage::bIgnoreSelf' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckDisableDamage, bDisableDamage) == 0x000009, "Member 'BP_DecalingDamageDetection_C_CheckDisableDamage::bDisableDamage' has a wrong offset!");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckDisablePassive, bIgnoreSelf) == 0x000010, "Member 'BP_DecalingDamageDetection_C_CheckDisablePassive::bIgnoreSelf' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckDisablePassive, bDisablePassive) == 0x000011, "Member 'BP_DecalingDamageDetection_C_CheckDisablePassive::bDisablePassive' has a wrong offset!");
...
static_assert(alignof(BP_DecalingDamageDetection_C_IgnoreTrace) == 0x000008, "Wrong alignment on BP_DecalingDamageDetection_C_IgnoreTrace");
static_assert(sizeof(BP_DecalingDamageDetection_C_IgnoreTrace) == 0x000010, "Wrong size on BP_DecalingDamageDetection_C_IgnoreTrace");
static_assert(offsetof(BP_DecalingDamageDetection_C_IgnoreTrace, Owner_0) == 0x000000, "Member 'BP_DecalingDamageDetection_C_IgnoreTrace::Owner_0' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_IgnoreTrace, bPairOnly) == 0x000008, "Member 'BP_DecalingDamageDetection_C_IgnoreTrace::bPairOnly' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_IgnoreTrace, bIgnore) == 0x000009, "Member 'BP_DecalingDamageDetection_C_IgnoreTrace::bIgnore' has a wrong offset!");
...
static_assert(sizeof(BP_DecalingDamageDetection_C_CheckAreaIn) == 0x000054, "Wrong size on BP_DecalingDamageDetection_C_CheckAreaIn");
...
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckAreaIn, bUseBoxCollision) == 0x00002C, "Member 'BP_DecalingDamageDetection_C_CheckAreaIn::bUseBoxCollision' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckAreaIn, BoxExtent) == 0x000030, "Member 'BP_DecalingDamageDetection_C_CheckAreaIn::BoxExtent' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckAreaIn, bTarget) == 0x00003C, "Member 'BP_DecalingDamageDetection_C_CheckAreaIn::bTarget' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckAreaIn, CallFunc_MakeLiteralFloat_ReturnValue) == 0x000040, "Member 'BP_DecalingDamageDetection_C_CheckAreaIn::CallFunc_MakeLiteralFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckAreaIn, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000044, "Member 'BP_DecalingDamageDetection_C_CheckAreaIn::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckAreaIn, CallFunc_IsSphereInBox_ReturnValue) == 0x000050, "Member 'BP_DecalingDamageDetection_C_CheckAreaIn::CallFunc_IsSphereInBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_DecalingDamageDetection_C_CheckAreaIn, CallFunc_HitCheck_ContinuedSphere_Sphere_bHit) == 0x000051, "Member 'BP_DecalingDamageDetection_C_CheckAreaIn::CallFunc_HitCheck_ContinuedSphere_Sphere_bHit' has a wrong offset!");
...
static_assert(alignof(BP_DecalingDamageDetection_C_IgnoreAttackHitNotifyOnAreaIn) == 0x000001, "Wrong alignment on BP_DecalingDamageDetection_C_IgnoreAttackHitNotifyOnAreaIn");
static_assert(sizeof(BP_DecalingDamageDetection_C_IgnoreAttackHitNotifyOnAreaIn) == 0x000001, "Wrong size on BP_DecalingDamageDetection_C_IgnoreAttackHitNotifyOnAreaIn");
static_assert(offsetof(BP_DecalingDamageDetection_C_IgnoreAttackHitNotifyOnAreaIn, bIgnore) == 0x000000, "Member 'BP_DecalingDamageDetection_C_IgnoreAttackHitNotifyOnAreaIn::bIgnore' has a wrong offset!");
