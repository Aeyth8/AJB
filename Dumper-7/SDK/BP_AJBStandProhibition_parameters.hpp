...
static_assert(offsetof(BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition, K2Node_Event_bTriggeredByStand) == 0x000004, "Member 'BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition::K2Node_Event_bTriggeredByStand' has a wrong offset!");
...
static_assert(offsetof(BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition, K2Node_Event_bTriggeredByStand1) == 0x000051, "Member 'BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition::K2Node_Event_bTriggeredByStand1' has a wrong offset!");
...
static_assert(offsetof(BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition, CallFunc_GetOwner_ReturnValue3) == 0x000078, "Member 'BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition::CallFunc_GetOwner_ReturnValue3' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition, K2Node_DynamicCast_AsBP_AJBIn_Game_Character2) == 0x000080, "Member 'BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition::K2Node_DynamicCast_AsBP_AJBIn_Game_Character2' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition, K2Node_DynamicCast_bSuccess4) == 0x000088, "Member 'BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition::K2Node_DynamicCast_bSuccess4' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition, CallFunc_HasLocalSharedController_ReturnValue1) == 0x000089, "Member 'BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition::CallFunc_HasLocalSharedController_ReturnValue1' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition, CallFunc_IsPlayerController_ReturnValue1) == 0x00008A, "Member 'BP_AJBStandProhibition_C_ExecuteUbergraph_BP_AJBStandProhibition::CallFunc_IsPlayerController_ReturnValue1' has a wrong offset!");
...
public:
	...
	class UBP_AJBHamonStatus_C*                   CallFunc_GetComponentByClass_ReturnValue;          // 0x0010(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           CallFunc_GetSecondTag_SecondTag;                   // 0x0018(0x0008)(NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(BP_AJBStandProhibition_C_GetSecondTag) == 0x000008, "Wrong alignment on BP_AJBStandProhibition_C_GetSecondTag");
static_assert(sizeof(BP_AJBStandProhibition_C_GetSecondTag) == 0x000028, "Wrong size on BP_AJBStandProhibition_C_GetSecondTag");
static_assert(offsetof(BP_AJBStandProhibition_C_GetSecondTag, SecondTag) == 0x000000, "Member 'BP_AJBStandProhibition_C_GetSecondTag::SecondTag' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_GetSecondTag, CallFunc_GetOwner_ReturnValue) == 0x000008, "Member 'BP_AJBStandProhibition_C_GetSecondTag::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_GetSecondTag, CallFunc_GetComponentByClass_ReturnValue) == 0x000010, "Member 'BP_AJBStandProhibition_C_GetSecondTag::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_GetSecondTag, CallFunc_GetSecondTag_SecondTag) == 0x000018, "Member 'BP_AJBStandProhibition_C_GetSecondTag::CallFunc_GetSecondTag_SecondTag' has a wrong offset!");
static_assert(offsetof(BP_AJBStandProhibition_C_GetSecondTag, CallFunc_IsValid_ReturnValue) == 0x000020, "Member 'BP_AJBStandProhibition_C_GetSecondTag::CallFunc_IsValid_ReturnValue' has a wrong offset!");
