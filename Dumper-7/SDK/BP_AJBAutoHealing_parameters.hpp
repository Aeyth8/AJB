...
static_assert(offsetof(BP_AJBAutoHealing_C_ExecuteUbergraph_BP_AJBAutoHealing, K2Node_CustomEvent_bSelfDamage) == 0x000073, "Member 'BP_AJBAutoHealing_C_ExecuteUbergraph_BP_AJBAutoHealing::K2Node_CustomEvent_bSelfDamage' has a wrong offset!");
...
static_assert(offsetof(BP_AJBAutoHealing_C_OnReceiveDamage, bSelfDamage) == 0x00001B, "Member 'BP_AJBAutoHealing_C_OnReceiveDamage::bSelfDamage' has a wrong offset!");
...
static_assert(sizeof(BP_AJBAutoHealing_C_PossibleHealing) == 0x000003, "Wrong size on BP_AJBAutoHealing_C_PossibleHealing");
...
static_assert(offsetof(BP_AJBAutoHealing_C_PossibleHealing, CallFunc_CheckActiveBitesTheDust_ReturnValue) == 0x000001, "Member 'BP_AJBAutoHealing_C_PossibleHealing::CallFunc_CheckActiveBitesTheDust_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AJBAutoHealing_C_PossibleHealing, CallFunc_Not_PreBool_ReturnValue) == 0x000002, "Member 'BP_AJBAutoHealing_C_PossibleHealing::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
