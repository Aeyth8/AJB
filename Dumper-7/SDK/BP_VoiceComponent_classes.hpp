...
public:
	...
	void DequeueVoiceTag(const struct FGameplayTag& VoiceTag);
	void ResetKillCount();
...
static_assert(sizeof(UBP_VoiceComponent_C) == 0x000250, "Wrong size on UBP_VoiceComponent_C");
...
static_assert(offsetof(UBP_VoiceComponent_C, IsEnabledStage05MatchStartVoice) == 0x000248, "Member 'UBP_VoiceComponent_C::IsEnabledStage05MatchStartVoice' has a wrong offset!");
