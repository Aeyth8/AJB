...
static_assert(alignof(BP_AJBGrownupMessage_C_RequestMessage) == 0x000008, "Wrong alignment on BP_AJBGrownupMessage_C_RequestMessage");
static_assert(sizeof(BP_AJBGrownupMessage_C_RequestMessage) == 0x000018, "Wrong size on BP_AJBGrownupMessage_C_RequestMessage");
static_assert(offsetof(BP_AJBGrownupMessage_C_RequestMessage, Text) == 0x000000, "Member 'BP_AJBGrownupMessage_C_RequestMessage::Text' has a wrong offset!");
