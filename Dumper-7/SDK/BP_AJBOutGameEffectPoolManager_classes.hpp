...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_AJBOutGameEffectPoolManager_C">();
	}
...
static_assert(alignof(ABP_AJBOutGameEffectPoolManager_C) == 0x000008, "Wrong alignment on ABP_AJBOutGameEffectPoolManager_C");
static_assert(sizeof(ABP_AJBOutGameEffectPoolManager_C) == 0x000418, "Wrong size on ABP_AJBOutGameEffectPoolManager_C");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, UberGraphFrame) == 0x000338, "Member 'ABP_AJBOutGameEffectPoolManager_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, ParticleEffectPool) == 0x000340, "Member 'ABP_AJBOutGameEffectPoolManager_C::ParticleEffectPool' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, GionEffectPool) == 0x000348, "Member 'ABP_AJBOutGameEffectPoolManager_C::GionEffectPool' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, DefaultSceneRoot) == 0x000350, "Member 'ABP_AJBOutGameEffectPoolManager_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, EffectScreen) == 0x000358, "Member 'ABP_AJBOutGameEffectPoolManager_C::EffectScreen' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, UseGionDataTable) == 0x000360, "Member 'ABP_AJBOutGameEffectPoolManager_C::UseGionDataTable' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, GionDataTable) == 0x000368, "Member 'ABP_AJBOutGameEffectPoolManager_C::GionDataTable' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, ParticleEffectCullDistance) == 0x0003B8, "Member 'ABP_AJBOutGameEffectPoolManager_C::ParticleEffectCullDistance' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, UseParticleDataTable) == 0x0003C0, "Member 'ABP_AJBOutGameEffectPoolManager_C::UseParticleDataTable' has a wrong offset!");
static_assert(offsetof(ABP_AJBOutGameEffectPoolManager_C, ParticleEffectData) == 0x0003C8, "Member 'ABP_AJBOutGameEffectPoolManager_C::ParticleEffectData' has a wrong offset!");
