...
static_assert(offsetof(UBP_AJBDamageAreaMaster_C, bDebugShowAdvanceCalcInfo) == 0x000111, "Member 'UBP_AJBDamageAreaMaster_C::bDebugShowAdvanceCalcInfo' has a wrong offset!");
static_assert(offsetof(UBP_AJBDamageAreaMaster_C, RangeLimitLoopCount) == 0x000114, "Member 'UBP_AJBDamageAreaMaster_C::RangeLimitLoopCount' has a wrong offset!");
