...
static_assert(sizeof(ABP_AJBPlacementTrapBase_C) == 0x000450, "Wrong size on ABP_AJBPlacementTrapBase_C");
...
static_assert(offsetof(ABP_AJBPlacementTrapBase_C, EmphasisParticle) == 0x000440, "Member 'ABP_AJBPlacementTrapBase_C::EmphasisParticle' has a wrong offset!");
static_assert(offsetof(ABP_AJBPlacementTrapBase_C, EmpasisParticleTag) == 0x000448, "Member 'ABP_AJBPlacementTrapBase_C::EmpasisParticleTag' has a wrong offset!");
