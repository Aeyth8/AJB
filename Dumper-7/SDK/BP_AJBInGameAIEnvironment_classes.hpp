...
static_assert(sizeof(UBP_AJBInGameAIEnvironment_C) == 0x000460, "Wrong size on UBP_AJBInGameAIEnvironment_C");
...
static_assert(offsetof(UBP_AJBInGameAIEnvironment_C, ImaginaryPlayerMovableStands) == 0x000410, "Member 'UBP_AJBInGameAIEnvironment_C::ImaginaryPlayerMovableStands' has a wrong offset!");
