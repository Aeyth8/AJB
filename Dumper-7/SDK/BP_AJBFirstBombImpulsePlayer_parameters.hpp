...
static_assert(offsetof(BP_AJBFirstBombImpulsePlayer_C_CheckDamagedActorOnly, CallFunc_CheckActiveState_bActiveState) == 0x000029, "Member 'BP_AJBFirstBombImpulsePlayer_C_CheckDamagedActorOnly::CallFunc_CheckActiveState_bActiveState' has a wrong offset!");
