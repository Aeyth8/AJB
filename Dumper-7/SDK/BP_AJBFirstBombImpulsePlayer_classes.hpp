...
static_assert(sizeof(ABP_AJBFirstBombImpulsePlayer_C) == 0x0004D0, "Wrong size on ABP_AJBFirstBombImpulsePlayer_C");
static_assert(offsetof(ABP_AJBFirstBombImpulsePlayer_C, UberGraphFrame_BP_AJBFirstBombImpulsePlayer_C) == 0x0004C0, "Member 'ABP_AJBFirstBombImpulsePlayer_C::UberGraphFrame_BP_AJBFirstBombImpulsePlayer_C' has a wrong offset!");
static_assert(offsetof(ABP_AJBFirstBombImpulsePlayer_C, TargetActor) == 0x0004C8, "Member 'ABP_AJBFirstBombImpulsePlayer_C::TargetActor' has a wrong offset!");
