...
static_assert(sizeof(BP_UnderwaterMaskingCylinder_C_UserConstructionScript) == 0x000020, "Wrong size on BP_UnderwaterMaskingCylinder_C_UserConstructionScript");
static_assert(offsetof(BP_UnderwaterMaskingCylinder_C_UserConstructionScript, CallFunc_GetStageUnderwaterMaskingCylinderHeightScale_Scale) == 0x000000, "Member 'BP_UnderwaterMaskingCylinder_C_UserConstructionScript::CallFunc_GetStageUnderwaterMaskingCylinderHeightScale_Scale' has a wrong offset!");
static_assert(offsetof(BP_UnderwaterMaskingCylinder_C_UserConstructionScript, CallFunc_GetStageUnderwaterMaskingCylinderRadiusScale_Scale) == 0x000004, "Member 'BP_UnderwaterMaskingCylinder_C_UserConstructionScript::CallFunc_GetStageUnderwaterMaskingCylinderRadiusScale_Scale' has a wrong offset!");
static_assert(offsetof(BP_UnderwaterMaskingCylinder_C_UserConstructionScript, CallFunc_MakeVector_ReturnValue) == 0x000008, "Member 'BP_UnderwaterMaskingCylinder_C_UserConstructionScript::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_UnderwaterMaskingCylinder_C_UserConstructionScript, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000018, "Member 'BP_UnderwaterMaskingCylinder_C_UserConstructionScript::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
