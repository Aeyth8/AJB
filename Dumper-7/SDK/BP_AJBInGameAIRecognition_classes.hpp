...
static_assert(sizeof(UBP_AJBInGameAIRecognition_C) == 0x000348, "Wrong size on UBP_AJBInGameAIRecognition_C");
...
static_assert(offsetof(UBP_AJBInGameAIRecognition_C, IsLifeTimeDisabled) == 0x000340, "Member 'UBP_AJBInGameAIRecognition_C::IsLifeTimeDisabled' has a wrong offset!");
