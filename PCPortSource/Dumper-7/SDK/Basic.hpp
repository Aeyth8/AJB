...
namespace Offsets
{
	constexpr int32 GObjects          = 0x02DE41B0;
	constexpr int32 AppendString      = 0x006837F0;
	constexpr int32 GNames            = 0x031535B0;
	constexpr int32 GWorld            = 0x03257AF0;
	constexpr int32 ProcessEvent      = 0x00823B30;
