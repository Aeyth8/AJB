...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_AJBKillerRushSkill_C;            // 0x0400(0x0008)(Transient, DuplicateTransient)
...
static_assert(sizeof(UBP_AJBKillerRushSkill_C) == 0x000408, "Wrong size on UBP_AJBKillerRushSkill_C");
static_assert(offsetof(UBP_AJBKillerRushSkill_C, UberGraphFrame_BP_AJBKillerRushSkill_C) == 0x000400, "Member 'UBP_AJBKillerRushSkill_C::UberGraphFrame_BP_AJBKillerRushSkill_C' has a wrong offset!");
