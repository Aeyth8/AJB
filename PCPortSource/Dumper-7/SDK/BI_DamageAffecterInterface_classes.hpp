...
static_assert(alignof(IBI_DamageAffecterInterface_C) == 0x000001, "Wrong alignment on IBI_DamageAffecterInterface_C");
static_assert(sizeof(IBI_DamageAffecterInterface_C) == 0x000001, "Wrong size on IBI_DamageAffecterInterface_C");
