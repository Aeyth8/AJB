...
static_assert(alignof(IBI_AJBInGameCharacterProperty_C) == 0x000001, "Wrong alignment on IBI_AJBInGameCharacterProperty_C");
static_assert(sizeof(IBI_AJBInGameCharacterProperty_C) == 0x000001, "Wrong size on IBI_AJBInGameCharacterProperty_C");
