...
static_assert(sizeof(BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag) == 0x000048, "Wrong size on BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag");
...
static_assert(offsetof(BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag, CallFunc_GetStringFromTable_bResult) == 0x000009, "Member 'BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag::CallFunc_GetStringFromTable_bResult' has a wrong offset!");
...
static_assert(offsetof(BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag, CallFunc_MatchesTag_ReturnValue) == 0x000020, "Member 'BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag::CallFunc_MatchesTag_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag, CallFunc_IsValid_ReturnValue) == 0x000040, "Member 'BP_AJBPassiveMessage_C_RequestAddMessageByGameplayTag::CallFunc_IsValid_ReturnValue' has a wrong offset!");
