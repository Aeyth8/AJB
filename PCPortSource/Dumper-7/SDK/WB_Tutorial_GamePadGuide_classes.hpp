...
static_assert(offsetof(UWB_Tutorial_GamePadGuide_C, Texture_Mirror_MIVariable) == 0x000240, "Member 'UWB_Tutorial_GamePadGuide_C::Texture_Mirror_MIVariable' has a wrong offset!");
