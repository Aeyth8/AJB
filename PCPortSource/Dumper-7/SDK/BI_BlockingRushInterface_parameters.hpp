...
static_assert(sizeof(BI_BlockingRushInterface_C_Blocking) == 0x000060, "Wrong size on BI_BlockingRushInterface_C_Blocking");
...
static_assert(offsetof(BI_BlockingRushInterface_C_Blocking, KnockbackVelocity) == 0x000050, "Member 'BI_BlockingRushInterface_C_Blocking::KnockbackVelocity' has a wrong offset!");
static_assert(offsetof(BI_BlockingRushInterface_C_Blocking, KnockbackIntensity) == 0x00005C, "Member 'BI_BlockingRushInterface_C_Blocking::KnockbackIntensity' has a wrong offset!");
