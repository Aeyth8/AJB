...
static_assert(sizeof(ABP_AJBBattleGameState_C) == 0x000518, "Wrong size on ABP_AJBBattleGameState_C");
...
static_assert(offsetof(ABP_AJBBattleGameState_C, BitesTheDustAffecter) == 0x0004C0, "Member 'ABP_AJBBattleGameState_C::BitesTheDustAffecter' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, HistoryInfoList) == 0x0004C8, "Member 'ABP_AJBBattleGameState_C::HistoryInfoList' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, HistorySerialNumber) == 0x0004D8, "Member 'ABP_AJBBattleGameState_C::HistorySerialNumber' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, bShouldRecordHistory) == 0x0004DC, "Member 'ABP_AJBBattleGameState_C::bShouldRecordHistory' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, RecordHistoryFrequency) == 0x0004E0, "Member 'ABP_AJBBattleGameState_C::RecordHistoryFrequency' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, bStopRecordHistory) == 0x0004E4, "Member 'ABP_AJBBattleGameState_C::bStopRecordHistory' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, bCanInvalidationHistory) == 0x0004E5, "Member 'ABP_AJBBattleGameState_C::bCanInvalidationHistory' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, OnBeginBitesTheDustDispatcher) == 0x0004E8, "Member 'ABP_AJBBattleGameState_C::OnBeginBitesTheDustDispatcher' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, OnEndBitesTheDustDispatcher) == 0x0004F8, "Member 'ABP_AJBBattleGameState_C::OnEndBitesTheDustDispatcher' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, OpenTheGameTimeForHighlight) == 0x000508, "Member 'ABP_AJBBattleGameState_C::OpenTheGameTimeForHighlight' has a wrong offset!");
static_assert(offsetof(ABP_AJBBattleGameState_C, BeginHighlightDateTime) == 0x000510, "Member 'ABP_AJBBattleGameState_C::BeginHighlightDateTime' has a wrong offset!");
