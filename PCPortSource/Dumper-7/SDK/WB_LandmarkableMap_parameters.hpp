...
static_assert(sizeof(WB_LandmarkableMap_C_CalcMapScale) == 0x000024, "Wrong size on WB_LandmarkableMap_C_CalcMapScale");
...
static_assert(offsetof(WB_LandmarkableMap_C_CalcMapScale, CallFunc_GetStageMiniMapScale_Scale) == 0x00000C, "Member 'WB_LandmarkableMap_C_CalcMapScale::CallFunc_GetStageMiniMapScale_Scale' has a wrong offset!");
static_assert(offsetof(WB_LandmarkableMap_C_CalcMapScale, CallFunc_GetStageMaxSize_MaxSize) == 0x000010, "Member 'WB_LandmarkableMap_C_CalcMapScale::CallFunc_GetStageMaxSize_MaxSize' has a wrong offset!");
static_assert(offsetof(WB_LandmarkableMap_C_CalcMapScale, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000014, "Member 'WB_LandmarkableMap_C_CalcMapScale::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_LandmarkableMap_C_CalcMapScale, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000018, "Member 'WB_LandmarkableMap_C_CalcMapScale::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WB_LandmarkableMap_C_CalcMapScale, CallFunc_Multiply_FloatFloat_ReturnValue1) == 0x00001C, "Member 'WB_LandmarkableMap_C_CalcMapScale::CallFunc_Multiply_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WB_LandmarkableMap_C_CalcMapScale, K2Node_Select_Default) == 0x000020, "Member 'WB_LandmarkableMap_C_CalcMapScale::K2Node_Select_Default' has a wrong offset!");
