...
static_assert(offsetof(BP_AJBHealingBase_C_ExecuteUbergraph_BP_AJBHealingBase, K2Node_Event_bFlag01) == 0x000028, "Member 'BP_AJBHealingBase_C_ExecuteUbergraph_BP_AJBHealingBase::K2Node_Event_bFlag01' has a wrong offset!");
static_assert(offsetof(BP_AJBHealingBase_C_ExecuteUbergraph_BP_AJBHealingBase, CallFunc_IsValid_ReturnValue) == 0x000029, "Member 'BP_AJBHealingBase_C_ExecuteUbergraph_BP_AJBHealingBase::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_AJBHealingBase_C_OnLongPressInteractEnded) == 0x000018, "Wrong size on BP_AJBHealingBase_C_OnLongPressInteractEnded");
...
static_assert(offsetof(BP_AJBHealingBase_C_OnLongPressInteractEnded, bFlag01) == 0x000010, "Member 'BP_AJBHealingBase_C_OnLongPressInteractEnded::bFlag01' has a wrong offset!");
