...
static_assert(sizeof(ABP_AJBGrowTree_C) == 0x000420, "Wrong size on ABP_AJBGrowTree_C");
...
static_assert(offsetof(ABP_AJBGrowTree_C, DelayTimeRootCollisionEnabled) == 0x000418, "Member 'ABP_AJBGrowTree_C::DelayTimeRootCollisionEnabled' has a wrong offset!");
