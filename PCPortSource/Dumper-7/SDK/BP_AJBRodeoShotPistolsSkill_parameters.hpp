...
static_assert(offsetof(BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill, K2Node_CustomEvent_bSelfDamage) == 0x000043, "Member 'BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill::K2Node_CustomEvent_bSelfDamage' has a wrong offset!");
static_assert(offsetof(BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill, K2Node_CustomEvent_IsEndured) == 0x000044, "Member 'BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill::K2Node_CustomEvent_IsEndured' has a wrong offset!");
static_assert(offsetof(BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill, CallFunc_TryToSpeakVoice_bWillBeSpoken) == 0x000045, "Member 'BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill::CallFunc_TryToSpeakVoice_bWillBeSpoken' has a wrong offset!");
static_assert(offsetof(BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill, CallFunc_EqualEqual_GameplayTag_ReturnValue) == 0x000046, "Member 'BP_AJBRodeoShotPistolsSkill_C_ExecuteUbergraph_BP_AJBRodeoShotPistolsSkill::CallFunc_EqualEqual_GameplayTag_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_AJBRodeoShotPistolsSkill_C_OnGiveDamage, bSelfDamage) == 0x000023, "Member 'BP_AJBRodeoShotPistolsSkill_C_OnGiveDamage::bSelfDamage' has a wrong offset!");
static_assert(offsetof(BP_AJBRodeoShotPistolsSkill_C_OnGiveDamage, IsEndured) == 0x000024, "Member 'BP_AJBRodeoShotPistolsSkill_C_OnGiveDamage::IsEndured' has a wrong offset!");
