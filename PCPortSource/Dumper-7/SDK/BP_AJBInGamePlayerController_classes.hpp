...
static_assert(sizeof(ABP_AJBInGamePlayerController_C) == 0x0008E8, "Wrong size on ABP_AJBInGamePlayerController_C");
...
static_assert(offsetof(ABP_AJBInGamePlayerController_C, PPVVSFilter) == 0x000898, "Member 'ABP_AJBInGamePlayerController_C::PPVVSFilter' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, bDebugEnableUserIDDigit) == 0x0008A0, "Member 'ABP_AJBInGamePlayerController_C::bDebugEnableUserIDDigit' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, DebugUserIDDigit) == 0x0008A4, "Member 'ABP_AJBInGamePlayerController_C::DebugUserIDDigit' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, OnDetermineEasyOperation_Local) == 0x0008A8, "Member 'ABP_AJBInGamePlayerController_C::OnDetermineEasyOperation_Local' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, OnDeterminePvEScore_Local) == 0x0008B8, "Member 'ABP_AJBInGamePlayerController_C::OnDeterminePvEScore_Local' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, bIsDebugAlwaysEyeMove) == 0x0008C8, "Member 'ABP_AJBInGamePlayerController_C::bIsDebugAlwaysEyeMove' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, bIsDebugAlwaysEyeMoveOnFreeCamera) == 0x0008C9, "Member 'ABP_AJBInGamePlayerController_C::bIsDebugAlwaysEyeMoveOnFreeCamera' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, bDebugAdvancedDisplayGion) == 0x0008CA, "Member 'ABP_AJBInGamePlayerController_C::bDebugAdvancedDisplayGion' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, OnDetermineStageNo_Local) == 0x0008D0, "Member 'ABP_AJBInGamePlayerController_C::OnDetermineStageNo_Local' has a wrong offset!");
static_assert(offsetof(ABP_AJBInGamePlayerController_C, BattleTimeSeconds) == 0x0008E0, "Member 'ABP_AJBInGamePlayerController_C::BattleTimeSeconds' has a wrong offset!");
