...
static_assert(sizeof(BI_DamageAffecterInterface_C_CheckAreaIn) == 0x000040, "Wrong size on BI_DamageAffecterInterface_C_CheckAreaIn");
...
static_assert(offsetof(BI_DamageAffecterInterface_C_CheckAreaIn, bUseBoxCollision) == 0x00002C, "Member 'BI_DamageAffecterInterface_C_CheckAreaIn::bUseBoxCollision' has a wrong offset!");
static_assert(offsetof(BI_DamageAffecterInterface_C_CheckAreaIn, BoxExtent) == 0x000030, "Member 'BI_DamageAffecterInterface_C_CheckAreaIn::BoxExtent' has a wrong offset!");
static_assert(offsetof(BI_DamageAffecterInterface_C_CheckAreaIn, bTarget) == 0x00003C, "Member 'BI_DamageAffecterInterface_C_CheckAreaIn::bTarget' has a wrong offset!");
...
static_assert(alignof(BI_DamageAffecterInterface_C_IgnoreAttackHitNotifyOnAreaIn) == 0x000001, "Wrong alignment on BI_DamageAffecterInterface_C_IgnoreAttackHitNotifyOnAreaIn");
static_assert(sizeof(BI_DamageAffecterInterface_C_IgnoreAttackHitNotifyOnAreaIn) == 0x000001, "Wrong size on BI_DamageAffecterInterface_C_IgnoreAttackHitNotifyOnAreaIn");
static_assert(offsetof(BI_DamageAffecterInterface_C_IgnoreAttackHitNotifyOnAreaIn, bIgnore) == 0x000000, "Member 'BI_DamageAffecterInterface_C_IgnoreAttackHitNotifyOnAreaIn::bIgnore' has a wrong offset!");
